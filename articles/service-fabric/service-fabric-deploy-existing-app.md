...
## <a name="use-yoeman-to-package-and-deploy-an-existing-executable-on-linux"></a>Yoeman gebruiken voor het pakket en implementeren van een bestaand uitvoerbaar bestand op Linux
