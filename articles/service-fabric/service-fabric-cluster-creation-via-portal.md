...
![Schermopname van de start board weergeven "Deploying Service Fabric-Cluster." ][Notifications]
...
Elk van de NodeTypes geeft u in uw cluster resultaten in een virtuele-Machineschaalset ophalen van de installatie. Zie [extern verbinding maken met een exemplaar van virtuele-Machineschaalset] [ remote-connect-to-a-vm-scale-set] voor meer informatie.
