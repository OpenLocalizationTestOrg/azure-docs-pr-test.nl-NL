...
Als uw gebruikers licenties met Azure multi-factor Authentication hebt, is er niets die u moet doen om de Azure MFA inschakelen. Als dat niet het geval is, moet u een multi-factor Authentication-provider maken in uw directory. U doet dit door de volgende stappen uit:
