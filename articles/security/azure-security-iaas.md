...
Opdrachten, zoals het controleren van e-mail en surfen op Internet onschuldige genoeg lijken uit te voeren. Maar verhoogde accounts te manipuleren door schadelijke actoren die Browse activiteiten, speciaal e-mailberichten of andere technieken voor toegang tot uw onderneming kunnen gebruiken, kan worden blootgesteld. We raden het gebruik van beveiligde Beheerwerkstations voor de uitvoering van alle Azure beheertaken bij wijze van blootstelling aan onbedoeld inbreuk te verminderen.

Privileged Access Workstations (poten) bieden een toegewijde besturingssysteem voor gevoelige taken--één die is beveiligd tegen aanvallen via Internet en bedreigingen met zich mee. Deze gevoelige taken en de accounts van het dagelijks gebruik werkstations en apparaten te scheiden sterke bescherming bieden tegen phishingaanvallen, toepassing en OS beveiligingsproblemen, verschillende imitatie aanvallen en credential theft aanvallen, zoals toetsaanslag logboekregistratie, Pass-the-Hash en Pass-the-Ticket.

De PAW aanpak is een uitbreiding van de praktijk gangbaar zijn en aanbevolen gebruik van een afzonderlijk toegewezen Administrator-account dat is gescheiden van een standaardgebruikersaccount. Een PAW biedt een betrouwbare werkstation voor die gevoelige accounts.
