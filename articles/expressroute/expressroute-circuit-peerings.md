...
# <a name="expressroute-circuits-and-routing-domains"></a>ExpressRoute-circuits en Routeringsdomeinen
 U moet bestellen een *ExpressRoute-circuit* uw on-premises infrastructuur verbinding te maken met Microsoft via een connectiviteitsprovider. De onderstaande afbeelding ziet u een logische representatie van de verbinding tussen uw WAN en Microsoft.
...
Connectiviteit wordt altijd gestart vanuit uw WAN met Microsoft Azure-services. Microsoft Azure-services kan niet worden verbindingen in uw netwerk via deze routeringsdomein te initiëren. Zodra openbare peering is ingeschakeld, kunt u zich geen verbinding maken met alle Azure-services. We kunt niet u services waarvoor adverteren we de routes naar selectief te kiezen. U kunt de lijst met voorvoegsels we aan u adverteren via deze peering bekijken de [Microsoft Azure Datacenter IP-adresbereiken](http://www.microsoft.com/download/details.aspx?id=41653) pagina. De pagina wordt wekelijks bijgewerkt.
