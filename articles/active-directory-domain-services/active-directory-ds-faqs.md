...
Nee. Azure AD Domain Services kunnen alleen worden ingeschakeld in de klassieke Azure-netwerk. U kunt de klassiek virtueel netwerk verbinden met een virtueel netwerk met behulp van virtueel netwerk voor het gebruik van uw beheerde domein in een virtueel netwerk van Resource Manager-peering van Resource Manager.

#### <a name="can-i-enable-azure-ad-domain-services-in-a-federated-azure-ad-directory-i-use-adfs-to-authenticate-users-for-access-to-office-365-can-i-enable-azure-ad-domain-services-for-this-directory"></a>Kan ik inschakelen Azure AD Domain Services in een federatieve Azure AD-directory? Ik gebruik AD FS voor verificatie van gebruikers voor toegang tot Office 365. Kan ik Azure AD Domain Services voor deze directory inschakelen?
...
De service zelf ondersteunt dit scenario niet direct. Azure AD Domain Services is beschikbaar in slechts één virtueel netwerk tegelijk. U kunt echter verbinding tussen meerdere virtuele netwerken te kunnen stellen Azure AD Domain Services met andere virtuele netwerken configureren. Dit artikel wordt beschreven hoe u kunt [verbinding maken met virtuele netwerken in Azure](../vpn-gateway/virtual-networks-configure-vnet-to-vnet-connection.md).
...
Nee. Azure AD Domain Services kunnen alleen worden geconfigureerd. de [klassieke Azure-portal](https://manage.windowsazure.com). We verwachten uitbreiden van ondersteuning voor de [Azure-portal](https://portal.azure.com) in de toekomst.
