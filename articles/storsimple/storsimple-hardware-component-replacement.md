...
|:--- |:--- |:--- |:--- |
| Chassis |1 |Nee |[Vervang Hallo chassis op uw StorSimple-apparaat](storsimple-chassis-replacement.md) |
...
| Back-up batterij |2 |Ja |[Vervang Hallo back-up batterij module op uw StorSimple-apparaat](storsimple-battery-replacement.md) |
...
Neem [contact op met Microsoft Support](storsimple-contact-microsoft-support.md) tooorder een van deze eenheden vervanging.
