...
> [!NOTE] 
> De aanbevolen methode voor het installeren van Update 5 is via de Azure-portal. Gebruik deze procedure als u de controle van de gateway niet bij het installeren van de updates via de Azure portal. De controle mislukt wanneer u een gateway die is toegewezen aan een niet-DATA 0-netwerkinterface en uw apparaat een softwareversie ouder is dan Update 1 wordt uitgevoerd.
