...
---
# <a name="use-hello-storsimple-device-manager-service-toomonitor-hardware-components-and-status"></a>Gebruik Hallo Apparaatbeheer StorSimple-service toomonitor hardware-onderdelen en status
## <a name="overview"></a>Overzicht
Dit artikel wordt beschreven Hallo verschillende fysieke en logische onderdelen in uw on-premises StorSimple 8000 series apparaat. Ook wordt uitgelegd hoe toomonitor Onderdeelstatus apparaat via Hallo Hallo **Status- en hardware health** blade in Hallo StorSimple-apparaat Manager-service.

Hallo **Status- en hardware health** blade toont de status van de hardware van alle onderdelen van het StorSimple-apparaat Hallo Hallo.
...
> [!NOTE]
> **Hallo hardwarestatus is niet beschikbaar voor een StorSimple-Cloud-apparaat (8010/8020).**
...
1. Navigeer te**apparaten**, selecteert u een specifieke StorSimple-apparaat. Ga te**Monitor > Hardware health**.

    ![](./media/storsimple-8000-monitor-hardware-status/hw-health1.png)

2. Zoek Hallo **hardwareonderdelen** sectie en kies uit de beschikbare Hallo-onderdelen. Gewoon op Hallo onderdeel label tooexpand Hallo lijst en Hallo-status van Hallo verschillende Apparaatonderdelen weergeven. Zie Hallo [lijst met gedetailleerde onderdelen voor de primaire behuizing Hallo](#component-list-for-primary-enclosure-of-storsimple-device) en Hallo [lijst met gedetailleerde onderdelen voor Hallo EBOD behuizing](#component-list-for-ebod-enclosure-of-storsimple-device).
...
3. Gebruik Hallo kleurcodering schema toointerpret Hallo onderdeelstatus te volgen:
   ...
   * **Met de zwarte tekst wit** – geeft aan een onderdeel dat is niet aanwezig.
   ...
   Hallo volgende schermafbeelding ziet u een apparaat met onderdelen in **OK**, **waarschuwing**, en **fout** status.
       
   ![](./media/storsimple-8000-monitor-hardware-status/hw-health3.png)

   Uitbreidbare Hallo **lijst met gedeelde onderdelen**, zien we dat Hallo NVRAM en Hallo cluster zijn gedegradeerd.

   ![](./media/storsimple-8000-monitor-hardware-status/hw-health5.png)

   Uitbreidbare Hallo **Controller 1 onderdelen** lijst ziet u dat clusterknooppunt Hallo is mislukt.  
...
Hallo Hallo volgende overzichten van de tabel fysieke en logische onderdelen die zijn opgenomen in Hallo primaire behuizing (aanwezig in 8100 en 8600) van uw on-premises StorSimple-apparaat.
...
Hallo Hallo volgende overzichten van de tabel fysieke en logische onderdelen die zijn opgenomen in Hallo EBOD behuizing (alleen aanwezig in 8600 model) van uw on-premises StorSimple-apparaat.
...
* toouse hello StorSimple Apparaatbeheer service tooadminister uw apparaat, ga te[gebruik Hallo StorSimple Apparaatbeheer service tooadminister uw StorSimple-apparaat](storsimple-8000-manager-service-administration.md).
...
* Als u tooexperience apparaat problemen doorgaat [contact op met Microsoft Support](storsimple-8000-contact-microsoft-support.md).
