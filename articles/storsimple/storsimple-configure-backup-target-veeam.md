...
3. In de klassieke Azure portal, de resourcenaam van de opgehaald en [registratiecode voor uw StorSimple Manager-service](storsimple-deployment-walkthrough-u2.md#step-2-get-the-service-registration-key).
4. Voer op de server waarop het script wordt uitgevoerd, PowerShell als beheerder. Typ de volgende opdracht:

    `Get-AzureStorSimpleDeviceBackupPolicy –DeviceName <device name>`

    Noteer de id van de back-upbeleid.
5. Maak een nieuwe PowerShell-script met de volgende code in Kladblok.
    ...
    ```
6. Geavanceerde opties voor het script toevoegen aan de back-uptaak, uw taak Veeam bewerken.
