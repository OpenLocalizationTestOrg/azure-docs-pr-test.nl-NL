...
Wanneer u taken uitvoert, moet u vaak een manier tootrack taak uitgevoerd. U vindt hier de status van de taak Hallo met behulp van de eigenschap State van Hallo taak. Zie voor meer informatie over Hallo eigenschap State [taakeigenschappen entiteit](https://docs.microsoft.com/rest/api/media/operations/job#job_entity_properties).
