...
* **Q. Wanneer gebruikt u Azure File-tegenover Azure Blob-tegenover Azure-schijf?**  
    ...
    Meer informatie over [beslissen wanneer u Azure Blobs, Azure-bestanden of Azure gegevensschijven gebruiken](../common/storage-decide-blobs-files-disks.md?toc=%2fazure%2fstorage%2ffiles%2ftoc.json)
...
* **Q. Hoe ga ik aan de slag met Azure File storage?**  
    ...
    * [Informatie over het maken van Azure-bestandsshare met behulp van de Portal](storage-how-to-create-file-share.md#create-file-share-through-the-portal)
    * [Informatie over het maken van bestandsshare in Azure met behulp van Powershell](storage-how-to-create-file-share.md#create-file-share-through-powershell)
    * [Informatie over het maken van bestandsshare in Azure met CLI](storage-how-to-create-file-share.md#create-file-share-through-command-line-interface-cli)
...
* **Q. Hoe kan ik Azure File storage fouten oplossen?**
    ...
    U kunt verwijzen naar [Azure File storage probleemoplossing artikel](storage-troubleshoot-windows-file-connection-problems.md) voor richtlijnen voor probleemoplossing voor end-to-end. 
...
* [De Azure CLI gebruiken met Azure Storage](../common/storage-azure-cli.md?toc=%2fazure%2fstorage%2ffiles%2ftoc.json)
