...
Maak een lege Node.js-toepassing. Zie voor instructies over het maken van een Node.js-toepassing [een Node.js-web-app maken in Azure App Service](../../app-service-web/app-service-web-get-started-nodejs.md), [bouwen en implementeren van een Node.js-toepassing naar een Azure Cloud Service](../../cloud-services/cloud-services-nodejs-develop-deploy-app.md) met Windows PowerShell of [bouwen en implementeren van een Node.js-web-app in Azure met behulp van Web Matrix](https://www.microsoft.com/web/webmatrix/).
...
* Ga naar de [Azure Storage teamblog] [Blog van Azure Storage-Team].
...
[Node.js-web-app met behulp van de Azure-tabel-Service](../../app-service-web/storage-nodejs-use-table-storage-web-site.md)
...
[Azure Storage Team Blog]: http://blogs.msdn.com/b/windowsazurestorage/ [bouwen en implementeren van een Node.js-web-app in Azure met behulp van Web Matrix]: https://www.microsoft.com/web/webmatrix/   
