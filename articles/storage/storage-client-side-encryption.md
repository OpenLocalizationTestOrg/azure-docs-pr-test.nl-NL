...
Zie voor een stapsgewijze zelfstudie u door het proces leidt van het versleutelen van blobs met client-side '-versleuteling en Azure Key Vault Hallo [blobs versleutelen en ontsleutelen in Microsoft Azure Storage met Azure Key Vault](storage-encrypt-decrypt-blobs-key-vault.md).
