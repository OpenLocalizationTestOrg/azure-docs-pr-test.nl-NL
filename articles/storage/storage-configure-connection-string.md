...
Een scenario waar u toospecify een expliciete eindpunt wilt mogelijk is wanneer u uw tooa eindpunt van Blob-opslag hebt toegewezen [aangepast domein](storage-custom-domain-name.md). In dat geval kunt u uw aangepaste eindpunt voor Blob storage in de verbindingsreeks. U kunt eventueel opgeven Hallo Standaardeindpunten voor Hallo andere services als uw toepassing worden gebruikt.
