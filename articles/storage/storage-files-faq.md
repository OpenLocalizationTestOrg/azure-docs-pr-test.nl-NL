...
* **Q. Wanneer gebruikt u Azure File-tegenover Azure Blob-tegenover Azure-schijf?**  
    ...
    Meer informatie over [gebruik wanneer toouse Azure Blobs, Azure-bestanden of Azure gegevensschijven](storage-decide-blobs-files-disks.md)
...
* **Q. Hoe ga ik aan de slag met Azure File storage?**  
    ...
    * [Meer informatie over hoe Azure File toocreate delen met behulp van Hallo Portal](storage-file-how-to-create-file-share.md#create-file-share-through-the-portal)
    * [Meer informatie over hoe Azure File toocreate delen met behulp van Powershell](storage-file-how-to-create-file-share.md#create-file-share-through-powershell)
    * [Meer informatie over hoe Azure File toocreate delen met CLI](storage-file-how-to-create-file-share.md#create-file-share-through-command-line-interface-cli)
...
* **Q. Hoe kan ik Azure File storage fouten oplossen?**
    ...
    U kunt te verwijzen[Azure File storage probleemoplossing artikel](storage-troubleshoot-file-connection-problems.md) voor richtlijnen voor probleemoplossing voor end-to-end. 
...
* [Hello Azure CLI gebruiken met Azure Storage](storage-azure-cli.md)
