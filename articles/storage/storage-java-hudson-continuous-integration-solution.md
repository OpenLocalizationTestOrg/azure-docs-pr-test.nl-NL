...
* Een Azure Storage-account. Als u nog een opslagaccount hebt, kunt u een maken met behulp van Hallo stappen op [een Opslagaccount maken](storage-create-storage-account.md#create-a-storage-account).
