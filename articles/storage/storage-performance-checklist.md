...
Voor een voorbeeld van hoe tooget metagegevens van een blob met .NET, Zie [Set eigenschappen ophalen en metagegevens en](storage-properties-metadata.md).  
...
Zie voor meer informatie artikel Hallo [hoe: Hallo inhoud van een bericht in de wachtrij wijzigen](storage-dotnet-how-to-use-queues.md#change-the-contents-of-a-queued-message).  
