...
3. **Kopiëren Hallo UNC-pad vanuit Hallo 'Connect' deelvenster in hello Azure-portal**: een gedetailleerde beschrijving van hoe toofind deze informatie vindt u [hier](storage-file-how-to-use-files-portal.md#connect-to-file-share).
