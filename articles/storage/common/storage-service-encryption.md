...
Azure File storage biedt bestandsshares in de cloud van Hallo Hallo standaard SMB-protocol gebruiken. U kunt een bestandsshare koppelen van een client on-premises of in Azure. Zodra gekoppeld, kunnen hulpprogramma's zoals Robocopy gebruikte toocopy bestanden worden via tooAzure bestandsshares. Zie voor meer informatie [hoe toomount Azure-bestandsshare op Windows](../files/storage-how-to-use-files-windows.md) en [hoe toomount Azure File share op Linux](../storage-how-to-use-files-linux.md).
...
toolearn meer, gaat u naar onze [aan de slag met Azure Blob storage met .NET](../blobs/storage-dotnet-how-to-use-blobs.md).
