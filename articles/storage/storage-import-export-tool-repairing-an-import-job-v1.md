...
U kunt uitvoeren Hallo Microsoft Azure-hulpprogramma voor importeren/exporteren met Hallo importeren van taak kopiëren-logboekbestanden en Hallo hulpprogramma wordt uploaden Hallo ontbrekende bestanden (of delen van een bestand) tooyour Windows Azure storage-account toocomplete import-taak.  
...
Hallo Hieronder volgt een voorbeeld van een logbestand kopiëren. In dit geval een 64 K stukje van een bestand op Hallo station dat is geleverd voor de import-taak Hallo is beschadigd. Hallo rest Hallo blobs in Hallo taak zijn geïmporteerd, omdat dit alleen Hallo fout die wordt aangegeven.  
...
Hallo `/PathMapFile` optie kunt u tooresolve deze fouten. U kunt opgeven Hallo-naam van Hallo-bestand waarin Hallo lijst met bestanden die Hallo hulpprogramma is niet in staat toocorrectly identificeren. Hallo Hier volgt een voorbeeld van de opdrachtregel vullen zou `9WM35C2V_pathmap.txt`:  
