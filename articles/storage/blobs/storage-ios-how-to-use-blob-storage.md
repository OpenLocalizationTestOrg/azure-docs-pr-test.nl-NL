...
* **useFlatBlobListing** - zoals vermeld in Hallo [Naming en verwijzen naar containers en blobs](#naming-and-referencing-containers-and-blobs) sectie Hoewel Hallo Blob-service een opslagschema platte is, kunt u een virtuele hiërarchie door de naam van de blobs met pad informatie. Niet-platte aanbieding is echter momenteel niet ondersteund. Deze functie is binnenkort beschikbaar. Nu u deze waarde moet **Ja**.
