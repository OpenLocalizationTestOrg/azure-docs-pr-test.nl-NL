...
> [!NOTE]
> Azure File storage ondersteunt alleen lokaal redundante opslag (LRS) en georedundant opslag (GRS). Zie voor meer informatie over Azure File Storage [overzicht van Azure File storage](storage-files-introduction.md).
>
