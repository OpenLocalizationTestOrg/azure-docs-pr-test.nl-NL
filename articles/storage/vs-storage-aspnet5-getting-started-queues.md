...
* Zie [aan de slag met Azure Queue storage met .NET](storage-dotnet-how-to-use-queues.md) voor meer informatie over het bewerken van programmatisch wachtrijen.
