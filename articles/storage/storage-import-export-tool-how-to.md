...
---
# <a name="using-hello-azure-importexport-tool"></a>Met behulp van hello Azure-hulpprogramma voor importeren/exporteren 
...
Deze documentatie is voor de meest recente versie Hallo van hello Azure-hulpprogramma voor importeren/exporteren. Raadpleeg voor informatie over het gebruik van Hallo v1 hulpprogramma [Using hello Azure-hulpprogramma voor importeren/exporteren v1](storage-import-export-tool-how-to-v1.md).
...
* [Hallo WAImportExport hulpprogramma instellen](storage-import-export-tool-setup.md)
