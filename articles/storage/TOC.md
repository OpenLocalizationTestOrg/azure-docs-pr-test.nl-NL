...
### [Koppelen van een beheerde schijf tooa virtuele machine van Windows met behulp van PowerShell](../virtual-machines/windows/attach-disk-ps.md)
...
### [Anonieme toegang tooblobs](storage-manage-access-to-resources.md)
...
### [Azure Virtual machines tooAzure beheerd schijven migreren](../virtual-machines/windows/migrate-to-managed-disks.md)
### [Migreren van AWS en andere platforms tooManaged schijven](../virtual-machines/windows/on-prem-to-azure.md)
...
#### [Migreren tooPremium Storage met Azure Site Recovery](storage-migrate-to-premium-storage-using-azure-site-recovery.md)
...
#### [TooPremium opslag migreren](storage-migration-to-premium-storage.md)
...
### [Hallo-Opslagemulator gebruiken](storage-use-emulator.md)
...
## Gegevens overdragen
### [Gegevens tooand verplaatsen van opslag](storage-moving-data.md)
### [AzCopy in Windows](storage-use-azcopy.md)
### [AzCopy in Linux](storage-use-azcopy-linux.md)
### [Met behulp van Hallo Import/Export-service](storage-import-export-service.md)
### [Met behulp van Hallo hulpprogramma voor importeren/exporteren](storage-import-export-tool-how-to.md)
#### [Instellen van Hallo hulpprogramma voor importeren/exporteren](storage-import-export-tool-setup.md)
...
#### [Het oplossen van problemen Hallo hulpprogramma voor importeren/exporteren](storage-import-export-tool-troubleshooting-v1.md)
...
### [Met behulp van hello (v1)-hulpprogramma voor importeren/exporteren](storage-import-export-tool-how-to-v1.md)
#### [Instellen van Hallo hulpprogramma voor importeren/exporteren](storage-import-export-tool-setup-v1.md)
...
#### [Bestandsindeling van het metagegevens- en eigenschappenbestand van de Import/Export-service](storage-import-export-file-format-metadata-and-properties.md)
#### [Bestandsindeling van het logboekbestand van de Import/Export-service](storage-import-export-file-format-log.md)
### [Met behulp van hello Azure Import/Export-service REST-API](storage-import-export-using-the-rest-api.md)
