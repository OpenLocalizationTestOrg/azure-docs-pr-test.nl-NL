        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informatie over Key Vault</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Videobibliotheek voor Key Vault</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Aan de slag met Key Vault</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Aan de slag met Key Vault vanuit een webtoepassing</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Key Vault instellen met end-to-end sleutelrotatie en -controle</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Node.js</h3>
                        <p><a href="http://azure.github.io/azure-sdk-for-node/azure-arm-keyvault/latest">Kluisbeheer</a></p>
                        <p><a href="http://azure.github.io/azure-sdk-for-node/azure-arm-keyvault/latest">Beheer van de kluisinhoud</a></p>
                    </div>
                </div>
            </div>
        </div>
