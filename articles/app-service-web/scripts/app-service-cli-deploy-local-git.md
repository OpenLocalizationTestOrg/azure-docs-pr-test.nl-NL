...
[!code-azurecli-interactive[belangrijkste](../../../cli_scripts/app-service/deploy-local-git/deploy-local-git.sh?highlight=3-5 "een web-app maken en implementeren van de code van een lokale Git-opslagplaats")]
