...
Dit script maakt gebruik van Hallo opdrachten toocreate een resourcegroep, web-app, storage-account en alle gerelateerde resources te volgen. Elke opdracht in Hallo tabel koppelingen toocommand specifieke documentatie.
...
| [AZ storage-account maken](https://docs.microsoft.com/cli/azure/storage/account#create) | Hiermee maakt u een opslagaccount. Dit is waar Hallo statische assets worden opgeslagen. |
