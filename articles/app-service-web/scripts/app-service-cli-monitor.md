...
| [Meld u AZ webapp downloaden](https://docs.microsoft.com/cli/azure/webapp/log#download) | Downloads Hallo logboeken Hallo een Azure-web-app tooyour lokale machine. |
