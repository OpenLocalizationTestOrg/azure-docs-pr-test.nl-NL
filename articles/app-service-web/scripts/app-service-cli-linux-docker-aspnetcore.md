...
In dit scenario leert u hoe toocreate een resourcegroep of Linux-app service-plan en web-app en implementeren van een ASP.NET Core-toepassing met behulp van Docker-Container.
...
| [AZ webapp config-container instellen](https://docs.microsoft.com/cli/azure/webapp/config/container#set) | Hiermee stelt u Hallo Docker-container voor hello Azure-web-app. |
