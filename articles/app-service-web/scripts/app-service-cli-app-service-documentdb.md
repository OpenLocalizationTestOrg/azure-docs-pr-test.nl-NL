...
---
# <a name="connect-a-web-app-toocosmos-db"></a>Verbinding maken met een web-app tooCosmos DB

In dit scenario leert u hoe toocreate een Cosmos-DB Azure-account en een Azure web-app. Vervolgens koppelt u Hallo Cosmos DB toohello web-app met app-instellingen.
...
Dit script maakt gebruik van Hallo opdrachten toocreate een resourcegroep, web-app, Cosmos-database en alle gerelateerde resources te volgen. Elke opdracht in Hallo tabel koppelingen toocommand specifieke documentatie.
...
| [AZ cosmosdb maken](https://docs.microsoft.com/en-us/cli/azure/cosmosdb#create) | Maakt een Cosmos-DB-account. Dit is het Hallo-gegevens worden opgeslagen. |
| [AZ cosmosdb lijst-sleutels](https://docs.microsoft.com/en-us/cli/azure/cosmosdb#list-keys) | Een lijst met Hallo toegangstoetsen voor Hallo Cosmos-DB-account opgegeven. |
