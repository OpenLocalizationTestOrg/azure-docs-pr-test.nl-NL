...
In dit scenario leert u hoe toocreate een resourcegroep of Linux-app service-plan en web-app en implementeren van een ASP.NET Core-toepassing met een Docker-Container uit hello Azure Container register.
