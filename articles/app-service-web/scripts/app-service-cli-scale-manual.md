...
[!code-azurecli-interactive[belangrijkste](../../../cli_scripts/app-service/scale-manual/scale-manual.sh "handmatig schalen")]
...
| [AZ appservice-abonnement bijwerken](https://docs.microsoft.com/cli/azure/appservice/plan#update) | De eigenschappen van de updates van de App Service-abonnement. |
