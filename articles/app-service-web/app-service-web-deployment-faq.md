...
Zie voor meer informatie [implementeren van uw app in App Service](web-sites-deploy.md).
...
De zelfstudie [uw eerste ASP.NET-web-app maken in Azure binnen vijf minuten](https://docs.microsoft.com/azure/app-service-web/web-sites-dotnet-get-started/) ziet u hoe ASP.NET-webtoepassing in een WebApp in App Service implementeren met Visual Studio 2015.
