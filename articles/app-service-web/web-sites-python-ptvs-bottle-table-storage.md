...
In deze zelfstudie gebruiken we [Python-Tools voor Visual Studio] voor het maken van een eenvoudige polls web-app met een van de PTVS-voorbeeldsjablonen. Deze zelfstudie is ook beschikbaar als een [video](https://www.youtube.com/watch?v=GJXDGaEPy94).
...
2. De projectsjablonen uit de [Python Tools 2.2 for Visual Studio Samples VSIX] zijn beschikbaar onder **Python**, **Samples**. Selecteer **Polls Bottle-webproject** en klik op OK om het project te maken.
...
2. Klik op de **nieuw** pictogram op de bovenkant van de Portal links, klikt u op **gegevens en opslag** > **Opslagaccount**.  Klik op de **maken** knop en vervolgens het storage-account een unieke naam geven en maak een nieuwe [resourcegroep](../azure-resource-manager/resource-group-overview.md) voor.
...
3. Klik op de **toegangssleutels** deel in het opslagaccount blade. Let op de accountnaam en key1.
...
In deze sectie configureert onze toepassing voor het gebruik van het opslagaccount dat we zojuist hebben gemaakt. Er moet vervolgens de toepassing lokaal uitvoeren.
...
1. In [Azure Portal], opent u de web-app-blade door te klikken op **Bladeren** > **App Services** > de naam van uw web-app.
...
Volg deze koppelingen voor meer informatie over Python Tools for Visual Studio, Bottle en Azure Table Storage.
