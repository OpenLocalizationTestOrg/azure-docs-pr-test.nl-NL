...
1. In de [Azure-portal](https://portal.azure.com), klik op App Service >  **&lt;any_app >** > **implementatiereferenties**.
    ...
    > [!NOTE]
    > U moet ten minste één app in de portal hebben voordat u toegang hebt tot de implementatie van de blade referenties. Bij de [Azure CLI](app-service-web-app-azure-resource-manager-xplat-cli.md), kunt u de referenties op gebruikersniveau zonder een bestaande app configureren.
