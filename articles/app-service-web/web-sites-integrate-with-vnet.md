...
Dit document richt zich voornamelijk op met de Azure portal voor VNet-integratie. Integratie in te schakelen VNet met uw app met behulp van PowerShell, volg de aanwijzingen hier: [uw app verbinden met het virtuele netwerk met behulp van PowerShell][IntPowershell].
