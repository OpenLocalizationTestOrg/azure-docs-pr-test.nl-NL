...
Deze zelfstudie leert u hoe u uw app implementeert [Azure App Service] van een Git-opslagplaats op uw lokale computer. App Service ondersteunt deze methode met de **lokale Git** Implementatieoptie wordt gebruikt in de [Azure Portal].  
Veel van de Git-opdrachten die worden beschreven in dit artikel worden automatisch uitgevoerd tijdens het maken van een App Service-app met de [Azure-opdrachtregelinterface] zoals beschreven [hier](app-service-web-get-started.md).
