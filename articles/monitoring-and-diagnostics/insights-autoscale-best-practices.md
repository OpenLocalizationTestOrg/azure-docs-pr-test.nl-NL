...
### <a name="considerations-for-scaling-threshold-values-for-special-metrics"></a>Overwegingen voor het schalen van drempelwaarden voor speciale metrische gegevens
 Voor speciale metrische gegevens zoals opslag- of Service Bus-wachtrij lengte metriek is de drempel voor het gemiddelde aantal berichten per huidige aantal exemplaren van beschikbaar. Kies het Kies zorgvuldig de drempelwaarde voor deze metrische gegevens.
