...
Houd er rekening mee dat Web-Apps Azure Diagnostics niet gebruiken. De equivalente informatie op [Web-Apps](../app-service-web/web-sites-enable-diagnostic-log.md)
