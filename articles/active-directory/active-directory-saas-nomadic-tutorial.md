...
In deze zelfstudie leert u hoe toointegrate Nomadic met Azure Active Directory (Azure AD).

Nomadic integreren met Azure AD biedt Hallo volgende voordelen:

- U kunt beheren in Azure AD die tooNomadic toegang heeft.
- U kunt uw gebruikers tooautomatically get aangemelde tooNomadic (Single Sign-On) met hun Azure AD-accounts kunt inschakelen.
...
Azure AD-integratie met Nomadic tooconfigure, moet u Hallo volgende items:
...
1. Nomadic van Hallo galerie toevoegen
2. Configureren en testen eenmalige aanmelding Azure AD

## <a name="add-nomadic-from-hello-gallery"></a>Nomadic van Hallo galerie toevoegen
tooconfigure hello integratie van Nomadic in Azure AD, moet u tooadd Nomadic uit Hallo galerie tooyour lijst met beheerde SaaS-apps.

**tooadd Nomadic via Hallo gallery uitvoeren Hallo stappen te volgen:**
...
4. Typ in het zoekvak Hallo **Nomadic**, selecteer **Nomadic** van resultaat deelvenster klik vervolgens op **toevoegen** knop tooadd Hallo-toepassing.
...
Voor één aanmelding toowork moet Azure AD tooknow welke Hallo equivalent in Nomadic is tooa gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker Hallo in Nomadic toobe tot stand gebracht.

Wijs in Nomadic, Hallo-waarde van Hallo **gebruikersnaam** in Azure AD als waarde Hallo Hallo **gebruikersnaam** tooestablish Hallo koppeling relatie.

tooconfigure en eenmalige aanmelding Azure AD-test met Nomadic, moet u toocomplete Hallo bouwstenen te volgen:
...
3. **[Maak een Nomadic testgebruiker](#create-a-nomadic-test-user)**  -toohave een equivalent van Britta Simon in Nomadic die is gekoppeld toohello Azure AD-weergave van de gebruiker.
...
In dit gedeelte Azure AD eenmalige aanmelding inschakelen in hello Azure-portal en eenmalige aanmelding in uw toepassing Nomadic configureren.

**Azure AD tooconfigure eenmalige aanmelding met Nomadic, Voer Hallo stappen te volgen:**

1. In de Azure-portal op Hallo Hallo **Nomadic** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op Hallo **Nomadic domein en de URL's** sectie, voert u Hallo stappen te volgen:
    ...
    a. In Hallo **aanmeldings-URL** textbox, typ een URL met Hallo patroon volgen:`https://<company name>.nomadic.fm/signin`

    b. In Hallo **id** textbox, typ een URL met Hallo patroon volgen: `https://<company name>.nomadic.fm/auth/saml2/sp`,`https://<company name>.staging.nomadic.fm/auth/saml2/sp`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Bijwerken van deze waarden Hello werkelijke aanmeldings-URL en -id. Neem contact op met [Nomadic Client ondersteuningsteam](mailto:help@nomadic.fm) tooget deze waarden. 
...
6.  tooget SSO geconfigureerd voor uw toepassing, neem contact op met [Nomadic ondersteuningsteam](mailto:help@nomadic.fm) en voorzien Hallo gedownload **metagegevens**.
...
In deze sectie kunt u een gebruiker Britta Simon aangeroepen in Nomadic maken. Neem contact op met [Nomadic ondersteuningsteam](mailto:help@nomadic.fm) tooadd Hallo gebruikers in Nomadic Hallo-platform.

### <a name="assign-hello-azure-ad-test-user"></a>Toewijzen van de testgebruiker hello Azure AD

In deze sectie kunt u Britta Simon toouse Azure eenmalige aanmelding inschakelen tooNomadic toegang verleent.

![Hallo-gebruikersrollen toewijzen][200] 

**tooassign Britta Simon tooNomadic, Voer Hallo stappen te volgen:**

1. In hello Azure-portal, Hallo toepassingen weergeven, openen en vervolgens toohello directoryweergave navigeren en ga te**bedrijfstoepassingen** klikt u vervolgens op **alle toepassingen**.

    ![Gebruiker toewijzen][201] 

2. Selecteer in de lijst met de toepassingen van Hallo **Nomadic**.
...
Wanneer u klikt op Hallo Nomadic tegel in Hallo Toegangsvenster, krijgt u automatisch aangemelde tooyour Nomadic toepassing.
