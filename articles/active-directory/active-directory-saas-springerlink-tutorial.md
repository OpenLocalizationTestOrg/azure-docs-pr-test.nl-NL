...
In deze zelfstudie leert u hoe toointegrate Springer koppelen aan Azure Active Directory (Azure AD).

Springer koppeling integreren met Azure AD biedt Hallo volgende voordelen:

- U kunt beheren in Azure AD die toegang tooSpringer koppeling heeft.
- U kunt uw gebruikers tooautomatically get aangemelde tooSpringer koppeling (Single Sign-On) met hun Azure AD-accounts kunt inschakelen.
...
Azure AD-integratie met Springer koppeling tooconfigure, moet u Hallo volgende items:
...
1. Springer koppeling toe te voegen uit Hallo-galerie
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-springer-link-from-hello-gallery"></a>Springer koppeling toe te voegen uit Hallo-galerie
tooconfigure hello integratie van Springer koppeling met Azure AD, moet u tooadd Springer koppeling uit Hallo galerie tooyour lijst met beheerde SaaS-apps.

**tooadd Springer koppeling via Hallo gallery uitvoeren Hallo stappen te volgen:**
...
4. Typ in het zoekvak Hallo **Springer koppeling**, selecteer **Springer koppeling** van resultaat deelvenster klik vervolgens op **toevoegen** knop tooadd Hallo-toepassing.
...
Voor één aanmelding toowork moet Azure AD tooknow welke Hallo equivalent in Springer koppeling is tooa gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de verwante gebruiker Hallo in Springer koppeling toobe tot stand gebracht.

In Springer koppeling, wijs Hallo-waarde van Hallo **gebruikersnaam** in Azure AD als waarde Hallo Hallo **gebruikersnaam** tooestablish Hallo koppeling relatie.

tooconfigure en test eenmalige aanmelding Azure AD met Springer koppeling, moet u toocomplete Hallo bouwstenen te volgen:
...
3. **[Toewijzen van de testgebruiker hello Azure AD](#assign-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD eenmalige aanmelding.
4. **[Test eenmalige aanmelding](#test-single-sign-on)**  -tooverify Hallo of configuratie werkt.

### <a name="configure-azure-ad-single-sign-on"></a>Eenmalige aanmelding Azure AD configureren

In dit gedeelte Azure AD eenmalige aanmelding inschakelen in hello Azure-portal en eenmalige aanmelding configureren in uw toepassing Springer koppeling.

**Voer tooconfigure Azure AD eenmalige aanmelding met Springer-koppeling Hallo stappen te volgen:**

1. In de Azure-portal op Hallo Hallo **Springer koppeling** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op Hallo **Springer koppeling domein en de URL's** sectie, indien gewenst tooconfigure Hallo toepassing in **IDP** modus gestart:
    ...
    a. In Hallo **id** textbox type Hallo URL:`https://fsso.springer.com`

    b. In Hallo **antwoord-URL** textbox type Hallo URL:`https://fsso-qa1.springer.com/federation/Consumer/metaAlias/SpringerServiceProvider`    
...
4. Controleer **weergeven geavanceerde instellingen voor URL**. U kunt eventueel tooconfigure Hallo toepassing in **SP** modus gestart:
    ...
    In Hallo **aanmeldings-URL** textbox type Hallo URL:`https://fsso.springer.com/federation/Consumer/metaAlias/SpringerServiceProvider`    
...
6. Hallo toogenerate **metagegevens** -url, Hallo volgende stappen uit te voeren:
    ...
    d. Ga nu toohello eigenschappenpagina van **Springer koppeling** en kopiëren Hallo **toepassings-Id** met **kopie** knop en plak deze in Kladblok.
...
7. tooconfigure eenmalige aanmelding op **Springer koppeling** zijde, moet u toosend Hallo gegenereerd **metagegevens-URL** te[Springer koppeling ondersteuningsteam](mailto:identity@springernature.com).
...
In deze sectie kunt u Britta Simon toouse Azure eenmalige aanmelding inschakelen door het verlenen van toegang tooSpringer koppeling.

![Hallo-gebruikersrollen toewijzen][200] 

**tooassign Britta Simon tooSpringer koppeling Hallo stappen uitvoeren:**

1. In hello Azure-portal, Hallo toepassingen weergeven, openen en vervolgens toohello directoryweergave navigeren en ga te**bedrijfstoepassingen** klikt u vervolgens op **alle toepassingen**.

    ![Gebruiker toewijzen][201] 

2. Selecteer in de lijst met de toepassingen van Hallo **Springer koppeling**.
...
Als u op Hallo Springer koppeling tegel in Hallo Toegangsvenster, krijgt u automatisch aangemelde tooyour Springer koppeling toepassing.
