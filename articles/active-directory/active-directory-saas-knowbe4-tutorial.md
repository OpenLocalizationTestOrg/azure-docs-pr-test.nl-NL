...
4. Typ in het zoekvak **KnowBe4 Awareness beveiligingstraining**.

    ![Een Azure AD-testgebruiker maken](./media/active-directory-saas-KnowBe4-tutorial/tutorial_knowbe4sat_search.png)

5. Selecteer in het deelvenster resultaten **KnowBe4 Awareness beveiligingstraining**, en klik vervolgens op **toevoegen** om toe te voegen van de toepassing.
...
3. **[Maken van een testgebruiker KnowBe4 Awareness beveiligingstraining](#creating-a-knowbe4-security-awareness-training-test-user)**  - KnowBe4 Awareness beveiligingstraining die is gekoppeld aan de Azure AD-weergave van de gebruiker van een exemplaar van Britta Simon bevatten.
...
3. Op de **Awareness KnowBe4-Training beveiligingsdomein en URL's** sectie, voert u de volgende stappen uit:
    ...
    In de **aanmeldings-URL** textbox, typ een URL met het volgende patroon volgen:`https://<companyname>.KnowBe4.com/auth/saml/<instancename>`

    > [!NOTE] 
    > De waarde is geen echte. Werk de waarde met de werkelijke URL voor eenmalige aanmelding. Neem contact op met [KnowBe4 beveiliging Awareness Training Client ondersteuningsteam](mailto:support@KnowBe4.com) de waarde op te halen. 
