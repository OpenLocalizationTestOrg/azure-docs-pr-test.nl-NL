...
3. Op de **Netsuite domein en de URL's** sectie, voert u de volgende stappen uit:
    ...
    > [!NOTE] 
    > Deze waarde is geen echte waarde. Werk de waarde met de werkelijke antwoord-URL. Neem contact op met [Netsuite ondersteuningsteam](http://www.netsuite.com/portal/services/support.shtml) deze waarde op te halen.
