...
> [!NOTE]
> Als uw Azure AD-tenant bevindt zich in Europa, raadpleegt u de [bekende problemen](#known-issues) hieronder.
...
Wanneer onderdelen 1-3 hebt voltooid, kunt u de inrichting service starten in de Azure Management Portal.
...
4. Synchronisatie van afzonderlijke gebeurtenissen, zoals gebruikers zijn wordt gelezen uit Workday en vervolgens later worden toegevoegd of bijgewerkt naar Active Directory kunnen worden weergegeven in de **controlelogboeken** tabblad. **[Raadpleeg de inrichting reporting guide voor gedetailleerde instructies voor het lezen van de controlelogboeken](active-directory-saas-provisioning-reporting.md)**

5.  Het Windows-toepassingslogboek op de agentcomputer worden alle bewerkingen die worden uitgevoerd via de agent weergegeven.
...
* **Controlelogboeken in Europese landen** - zoals van de release van deze technical preview, een bekend probleem met is de [controlelogboeken](active-directory-saas-provisioning-reporting.md) voor de Workday-connector-apps die niet voorkomen de [Azure-portal](https://portal.azure.com) als de Azure AD-tenant bevindt zich in een Europese Datacenter. Er ontbreekt een oplossing voor dit probleem. Controleer of deze ruimte in de nabije toekomst weer voor updates. 
