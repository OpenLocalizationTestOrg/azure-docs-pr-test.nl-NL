...
In deze zelfstudie leert u hoe toointegrate ZIVVER met Azure Active Directory (Azure AD).

ZIVVER integreren met Azure AD biedt Hallo volgende voordelen:

- U kunt beheren in Azure AD die tooZIVVER toegang heeft.
- U kunt uw gebruikers tooautomatically get aangemelde tooZIVVER (Single Sign-On) met hun Azure AD-accounts kunt inschakelen.
...
Azure AD-integratie met ZIVVER tooconfigure, moet u Hallo volgende items:
...
1. Het toevoegen van ZIVVER van Hallo-galerie
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-zivver-from-hello-gallery"></a>Het toevoegen van ZIVVER van Hallo-galerie
tooconfigure hello integratie van ZIVVER in Azure AD, moet u tooadd ZIVVER uit Hallo galerie tooyour lijst met beheerde SaaS-apps.

**tooadd ZIVVER via Hallo gallery uitvoeren Hallo stappen te volgen:**
...
4. Typ in het zoekvak Hallo **ZIVVER**, selecteer **ZIVVER** van resultaat deelvenster klik vervolgens op **toevoegen** knop tooadd Hallo-toepassing.
...
Voor één aanmelding toowork moet Azure AD tooknow welke Hallo equivalent in ZIVVER is tooa gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker Hallo in ZIVVER toobe tot stand gebracht.

Wijs in ZIVVER, Hallo-waarde van Hallo **gebruikersnaam** in Azure AD als waarde Hallo Hallo **gebruikersnaam** tooestablish Hallo koppeling relatie.

tooconfigure en eenmalige aanmelding Azure AD-test met ZIVVER, moet u toocomplete Hallo bouwstenen te volgen:
...
3. **[Maak een testgebruiker ZIVVER](#create-a-zivver-test-user)**  -toohave een equivalent van Britta Simon in ZIVVER die is gekoppeld toohello Azure AD-weergave van de gebruiker.
...
In dit gedeelte Azure AD eenmalige aanmelding inschakelen in hello Azure-portal en eenmalige aanmelding in uw toepassing ZIVVER configureren.

**Azure AD tooconfigure eenmalige aanmelding met ZIVVER, Voer Hallo stappen te volgen:**

1. In de Azure-portal op Hallo Hallo **ZIVVER** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op Hallo **ZIVVER domein en de URL's** sectie, voert u Hallo stappen te volgen:
    ...
    In Hallo **id** textbox type Hallo URL:`https://app.zivver.com/SAML/Zivver`
...
6. tooconfigure eenmalige aanmelding op **ZIVVER** zijde, moet u toosend Hallo gedownload **Metadata XML** te[ZIVVER ondersteuningsteam](https://support.zivver.com). Ze deze instelling toohave Hallo SAML SSO-verbinding juist is ingesteld op beide zijden ingesteld.
...
In deze sectie kunt u een gebruiker Britta Simon aangeroepen in ZIVVER maken. Werken met [ZIVVER ondersteuningsteam](https://support.zivver.com) tooadd Hallo gebruikers in Hallo ZIVVER platform.

### <a name="assign-hello-azure-ad-test-user"></a>Toewijzen van de testgebruiker hello Azure AD

In deze sectie kunt u Britta Simon toouse Azure eenmalige aanmelding inschakelen tooZIVVER toegang verleent.

![Hallo-gebruikersrollen toewijzen][200] 

**tooassign Britta Simon tooZIVVER, Voer Hallo stappen te volgen:**

1. In hello Azure-portal, Hallo toepassingen weergeven, openen en vervolgens toohello directoryweergave navigeren en ga te**bedrijfstoepassingen** klikt u vervolgens op **alle toepassingen**.

    ![Gebruiker toewijzen][201] 

2. Selecteer in de lijst met de toepassingen van Hallo **ZIVVER**.
...
Als u op Hallo ZIVVER-tegel in Hallo Toegangsvenster, krijgt u automatisch aangemelde tooyour ZIVVER toepassing.
