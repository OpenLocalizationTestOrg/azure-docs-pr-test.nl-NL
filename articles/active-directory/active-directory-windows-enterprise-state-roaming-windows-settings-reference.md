...
Hallo Hieronder volgt een volledige lijst met alle Hallo-instellingen die worden verplaatste of een back-up in Windows 10. 

## <a name="devices-and-endpoints"></a>Apparaten en -eindpunten
Zie de volgende tabel voor een overzicht van het Hallo-apparaten en accounttypen die worden ondersteund door Hallo sync, back-up, Hallo en herstellen van framework in Windows 10.
...
Windows-instellingen in het algemeen standaard synchroniseren, maar sommige instellingen zijn alleen een back-up, zoals Hallo-lijst van geïnstalleerde toepassingen op een apparaat. Back-up is voor mobiele apparaten alleen en die momenteel niet beschikbaar voor gebruikers Enterprise State Roaming. Back-up maakt gebruik van een Microsoft-account en Hallo-instellingen en toepassingsgegevens opgeslagen in OneDrive. Als een gebruiker wordt synchronisatie op Hallo-apparaat met behulp van de app instellingen Hallo uitgeschakeld, wordt toepassingsgegevens die normaal gesproken wordt gesynchroniseerd het back-up alleen. Back-upgegevens kan alleen worden benaderd via de herstelbewerking Hallo tijdens de eerste sessie van een nieuw apparaat Hallo. Back-ups kunnen kunnen worden uitgeschakeld via instellingen Hallo-apparaten, en worden beheerd en verwijderd via een van de gebruiker Hallo OneDrive-account.

## <a name="windows-settings-overview"></a>Overzicht van Windows-instellingen
Hallo zijn volgende Instellingengroepen beschikbaar voor synchronisatie van eindgebruikers tooenable-of uitschakelen op Windows 10-apparaten.
...
In Hallo volgende tabel, verwijst de andere vermeldingen in Hallo instellingengroep kolom toosettings die kan worden uitgeschakeld door te gaan tooSettings > Accounts > uw instellingen synchroniseren > andere Windows-instellingen. 

Interne gegevens in Hallo instellingengroep kolom verwijzen toosettings en apps die alleen wordt gesynchroniseerd binnen Hallo app zelf of door het uitschakelen van de synchronisatie voor de hele Hallo-apparaat met beheer van mobiele apparaten (MDM) of instellingen voor Groepsbeleid kunnen worden uitgeschakeld.
Instellingen die niet kunnen worden gebruikt of de synchronisatie wordt niet tooa groep behoren.
...
| **Apparaten**: gedeelde printers die u hebt te verbonden|X |X |andere |
...
| **Edge-browser**: Hallo thuis knop weergeven <sup> [[1]](#footnote-1)</sup> |Synchronisatie |Synchronisatie |interne |
| **Edge-browser**: pop-ups blokkeren <sup> [[1]](#footnote-1)</sup> |Synchronisatie |Synchronisatie |interne |
| **Edge-browser**: vragen welke toodo met elke download <sup> [[1]](#footnote-1)</sup> |Synchronisatie |Synchronisatie |interne |
| **Edge-browser**: toosave wachtwoorden bieden <sup> [[1]](#footnote-1)</sup> |Synchronisatie |Synchronisatie |interne |
...
| **Taal**: CHS WUBI - weergeven Hallo resterende coderen van Hallo candidate |Synchronisatie |X |Taal |
...
| **Vergrootglas**: bijhouden - Volg Hallo toetsenbordfocus |Synchronisatie |X |Toegankelijkheid |
| **Vergrootglas**: bijhouden - Hallo-muisaanwijzer volgen |Synchronisatie |X |Toegankelijkheid |
| **Vergrootglas**: starten wanneer gebruikers zich aanmelden (standaard uitgeschakeld) |Synchronisatie |X |Toegankelijkheid |
| **Muis**: Hallo grootte van de muisaanwijzer wijzigen |Synchronisatie |X |andere |
| **Muis**: Hallo kleur van de muisaanwijzer wijzigen |Synchronisatie |X |andere |
...
| **Narrator**: sleutels op Hallo Schermtoetsenbord activeren wanneer u uw vinger (standaard uitgeschakeld) |Synchronisatie |X |Toegankelijkheid |
| **Betere toegankelijkheid**: Hallo dikte van Hallo knipperende cursor instellen |Synchronisatie |X |Toegankelijkheid |
...
| **Typen**: een periode nadat ik dubbele tikken Hallo SPATIEBALK toevoegen |Synchronisatie |Back-up |Taal |
| **Typen**: hoofdletter Hallo van elke zin |Synchronisatie |Back-up |Taal |
