...
In deze zelfstudie leert u hoe toointegrate Predictix prijs Reporting met Azure Active Directory (Azure AD).

Predictix prijs Reporting integreren met Azure AD biedt Hallo volgende voordelen:

- U kunt beheren in Azure AD die toegang tooPredictix prijs Reporting heeft.
- U kunt uw gebruikers tooautomatically get aangemelde tooPredictix prijs Reporting (Single Sign-On) inschakelen met hun Azure AD-accounts.
...
Azure AD-integratie met Predictix prijs Reporting tooconfigure, moet u Hallo volgende items:
...
1. Het toevoegen van Predictix prijs Reporting van Hallo-galerie
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-predictix-price-reporting-from-hello-gallery"></a>Het toevoegen van Predictix prijs Reporting van Hallo-galerie
tooconfigure hello integratie van Predictix prijs rapportage in Azure AD, moet u tooadd Predictix prijs Reporting uit Hallo galerie tooyour lijst met beheerde SaaS-apps.

**tooadd Predictix prijs Reporting via Hallo gallery uitvoeren Hallo stappen te volgen:**
...
4. Typ in het zoekvak Hallo **Predictix prijs Reporting**, selecteer **Predictix prijs Reporting** van resultaat deelvenster klik vervolgens op **toevoegen** knop tooadd Hallo-toepassing.
...
Voor één aanmelding toowork moet Azure AD tooknow welke Hallo equivalent in Predictix prijs Reporting is tooa gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de verwante gebruiker Hallo in Predictix prijs Reporting toobe tot stand gebracht.

Wijs in het Predictix prijs rapportage, Hallo-waarde van Hallo **gebruikersnaam** in Azure AD als waarde Hallo Hallo **gebruikersnaam** tooestablish Hallo koppeling relatie.

tooconfigure en test eenmalige aanmelding Azure AD met Predictix prijs rapportage, moet u toocomplete Hallo bouwstenen te volgen:
...
3. **[Maak een testgebruiker Predictix prijs Reporting](#create-a-predictix-price-reporting-test-user)**  -toohave een equivalent van Britta Simon in Predictix prijs rapportage die is gekoppeld toohello Azure AD-weergave van de gebruiker.
...
In dit gedeelte Azure AD eenmalige aanmelding inschakelen in hello Azure-portal en eenmalige aanmelding in uw toepassing Predictix prijs rapportage configureren.

**tooconfigure eenmalige aanmelding Azure AD met Predictix prijs rapportage, Voer Hallo stappen te volgen:**

1. In de Azure-portal op Hallo Hallo **Predictix prijs Reporting** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op Hallo **Predictix prijs Reporting domein en de URL's** sectie, voert u Hallo stappen te volgen:
    ...
    a. In Hallo **aanmeldings-URL** textbox, typ een URL met Hallo patroon volgen:`https://<companyname-pricing>.predictix.com/sso/request`
    ...
    > [!NOTE] 
    > Deze waarden zijn niet echt. Bijwerken van deze waarden Hello werkelijke aanmeldings-URL en -id. Neem contact op met [Predictix prijs Reporting Client ondersteuningsteam](http://www.infor.com/company/customer-center/) tooget deze waarden. 
...
6. Op Hallo **Predictix prijs Reporting configuratie** sectie, klikt u op **configureren Predictix prijs Reporting** tooopen **eenmalige aanmelding configureren** venster. Kopiëren Hallo **Sign-Out-URL, SAML entiteit-ID en SAML Single Sign-On Service-URL** van Hallo **Naslaggids punt.**
...
In deze sectie maakt maakt u een gebruiker die Britta Simon aangeroepen in Predictix prijs Reporting. Werken met [ondersteuningsteam Predictix prijs Reporting](http://www.infor.com/company/customer-center/) tooadd Hallo gebruikers in Hallo Predictix prijs Reporting platform.

### <a name="assign-hello-azure-ad-test-user"></a>Toewijzen van de testgebruiker hello Azure AD

In deze sectie kunt u Britta Simon toouse Azure eenmalige aanmelding inschakelen door het verlenen van toegang tooPredictix prijs Reporting.

![Hallo-gebruikersrollen toewijzen][200] 

**tooassign Britta Simon tooPredictix prijs rapportage, Voer Hallo stappen te volgen:**

1. In hello Azure-portal, Hallo toepassingen weergeven, openen en vervolgens toohello directoryweergave navigeren en ga te**bedrijfstoepassingen** klikt u vervolgens op **alle toepassingen**.

    ![Gebruiker toewijzen][201] 

2. Selecteer in de lijst met de toepassingen van Hallo **Predictix prijs Reporting**.
...
Als u op Hallo Predictix prijs Reporting tegel in Hallo Toegangsvenster, krijgt u automatisch aangemelde tooyour Predictix prijs Reporting toepassing.
