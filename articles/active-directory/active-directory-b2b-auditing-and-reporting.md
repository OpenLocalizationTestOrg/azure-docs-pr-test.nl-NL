...
Met gastgebruikers hebt u controle mogelijkheden vergelijkbare toowith lid gebruikers. Hier volgt een voorbeeld van Hallo uitnodiging en inwisseling historie van genodigde Sam Oogle:

![Controlelogboek](./media/active-directory-b2b-auditing-and-reporting/audit-log.png)

U kunt Duik in elk van deze gebeurtenissen tooget Hallo details. Bijvoorbeeld: we kijken naar Hallo acceptatie details.

![Details van computeractiviteit](./media/active-directory-b2b-auditing-and-reporting/activity-details.png)

U kunt ook deze logboeken exporteren vanuit Azure AD en gebruik Hallo rapportage van uw keuze tooget aangepaste rapporten.
