...
3. Op de **Trakstar domein en de URL's** sectie, voert u de volgende stappen uit:
    ...
    a. In de **aanmeldings-URL** textbox, typ een URL met het volgende patroon volgen:`https://app.trakstar.com/auth/saml/callback?namespace=<NAMESPACE>`

    b. In de **id** textbox, typ een URL met het volgende patroon volgen:`https://<subdomain>.trakstar.com`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Deze waarden bijwerken met het werkelijke aanmeldings-URL en de id. Neem contact op met [Trakstar Client ondersteuningsteam](mailto:integrations@trakstar.com) ophalen van deze waarden. 
...
7. Eenmalige aanmelding configureren op **Trakstar** zijde, moet u de gedownloade verzenden **certificaat (Base64)**, **Sign-Out-URL, SAML entiteit-ID en SAML Single Sign-On Service-URL**naar [Trakstar ondersteuningsteam](mailto:integrations@trakstar.com). 
...
Het doel van deze sectie is het maken van een gebruiker Britta Simon in Trakstar genoemd. Werken met [Trakstar ondersteuningsteam](mailto:integrations@trakstar.com) de gebruikers in het account Trakstar toevoegen. 
