...
In deze zelfstudie leert u hoe toointegrate InTime met Azure Active Directory (Azure AD).

InTime integreren met Azure AD biedt Hallo volgende voordelen:

- U kunt beheren in Azure AD die tooInTime toegang heeft.
- U kunt uw gebruikers tooautomatically get aangemelde tooInTime (Single Sign-On) met hun Azure AD-accounts kunt inschakelen.
...
Azure AD-integratie met InTime tooconfigure, moet u Hallo volgende items:
...
1. Het toevoegen van InTime van Hallo-galerie
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-intime-from-hello-gallery"></a>Het toevoegen van InTime van Hallo-galerie
tooconfigure hello integratie van InTime in Azure AD, moet u tooadd InTime uit Hallo galerie tooyour lijst met beheerde SaaS-apps.

**tooadd InTime via Hallo gallery uitvoeren Hallo stappen te volgen:**
...
4. Typ in het zoekvak Hallo **InTime**, selecteer **InTime** van resultaat deelvenster klik vervolgens op **toevoegen** knop tooadd Hallo-toepassing.
...
Voor één aanmelding toowork moet Azure AD tooknow welke Hallo equivalent in InTime is tooa gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker Hallo in InTime toobe tot stand gebracht.

Wijs in InTime, Hallo-waarde van Hallo **gebruikersnaam** in Azure AD als waarde Hallo Hallo **gebruikersnaam** tooestablish Hallo koppeling relatie.

tooconfigure en eenmalige aanmelding Azure AD-test met InTime, moet u toocomplete Hallo bouwstenen te volgen:
...
3. **[Maak een InTime testgebruiker](#create-a-intime-test-user)**  -toohave een equivalent van Britta Simon in InTime die is gekoppeld toohello Azure AD-weergave van de gebruiker.
...
In dit gedeelte Azure AD eenmalige aanmelding inschakelen in hello Azure-portal en eenmalige aanmelding in uw toepassing InTime configureren.

**Azure AD tooconfigure eenmalige aanmelding met InTime, Voer Hallo stappen te volgen:**

1. In de Azure-portal op Hallo Hallo **InTime** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op Hallo **InTime domein en de URL's** sectie, voert u Hallo stappen te volgen:
    ...
    a. In Hallo **aanmeldings-URL** textbox type Hallo URL:`https://intime6.intimesoft.com/mytime/login/login.xhtml`

    b. In Hallo **id** textbox type Hallo URL:`https://auth.intimesoft.com/auth/realms/master`
...
5. Uw toepassing InTime verwacht Hallo SAML asserties in een specifieke indeling waarvoor u tooadd aangepast kenmerk toewijzingen tooyour SAML-token kenmerken-configuratie is vereist. Hallo volgende Schermafbeelding toont een voorbeeld voor deze. Hallo standaardwaarde van **gebruikers-id** is **user.userprincipalname** maar InTime deze toobe toegewezen met e-mailadres van de gebruiker Hallo verwacht. Die u kunt **user.mail** kenmerk uit de lijst Hallo of Hallo juiste kenmerkwaarde op basis van de organisatieconfiguratie van uw gebruiken 
...
7. Op Hallo **InTime configuratie** sectie, klikt u op **InTime configureren** tooopen **eenmalige aanmelding configureren** venster. Kopiëren Hallo **Sign-Out URL's, en SAML Single Sign-On Service** van Hallo **Naslaggids punt.**

    ![InTime configuratie](./media/active-directory-saas-intime-tutorial/tutorial_intime_configure.png) 

8. tooconfigure eenmalige aanmelding op **InTime** zijde, moet u toosend Hallo gedownload **Metadata XML**, **Sign-Out URL's, en SAML Single Sign-On Service** te[InTime ondersteuningsteam](mailto:hdollard@intimesoft.com). Ze deze instelling toohave Hallo SAML SSO-verbinding juist is ingesteld op beide zijden ingesteld.
...
In deze sectie kunt u een gebruiker Britta Simon aangeroepen in InTime maken. Werken met [InTime ondersteuningsteam](mailto:hdollard@intimesoft.com) tooadd Hallo gebruikers in InTime Hallo-platform. Gebruikers moeten worden gemaakt en worden geactiveerd voordat u eenmalige aanmelding gebruiken.

### <a name="assign-hello-azure-ad-test-user"></a>Toewijzen van de testgebruiker hello Azure AD

In deze sectie kunt u Britta Simon toouse Azure eenmalige aanmelding inschakelen tooInTime toegang verleent.

![Hallo-gebruikersrollen toewijzen][200] 

**tooassign Britta Simon tooInTime, Voer Hallo stappen te volgen:**

1. In hello Azure-portal, Hallo toepassingen weergeven, openen en vervolgens toohello directoryweergave navigeren en ga te**bedrijfstoepassingen** klikt u vervolgens op **alle toepassingen**.

    ![Gebruiker toewijzen][201] 

2. Selecteer in de lijst met de toepassingen van Hallo **InTime**.
...
Wanneer u klikt op Hallo InTime tegel in Hallo Toegangsvenster, krijgt u de aanmeldingspagina Hallo van uw toepassing InTime. Klik op Hallo **aanmelding** knop, en vervolgens een reeks IdPs wordt weergegeven op een lijst met knoppen. Klik op **IDP naam** gegeven door [InTime ondersteuningsteam](mailto:hdollard@intimesoft.com) toologin in uw toepassing InTime. Zie voor meer informatie over het toegangsvenster [inleiding toohello Toegangspaneel](active-directory-saas-access-panel-introduction.md). 
