...
Wanneer een toepassing wordt geregistreerd bij Azure AD, registreert app-ontwikkelaar Hallo federation-gerelateerde informatie met Azure AD. Dit omvat Hallo **omleidings-URI** en **Metadata URI** van Hallo-toepassing.

Azure AD gebruikt Hallo **Metadata URI** Hallo cloud service tooretrieve Hallo sleutel en Hallo afmelding URI van de cloudservice Hallo ondertekening. Als de toepassing hello biedt geen ondersteuning voor een URI-metagegevens, Hallo developer moet contact opnemen met Microsoft ondersteuning tooprovide Hallo afmelding URI en de handtekeningsleutel.
