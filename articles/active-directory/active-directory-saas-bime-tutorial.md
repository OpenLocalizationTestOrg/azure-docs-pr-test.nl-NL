...
In deze zelfstudie leert u hoe toointegrate Bime met Azure Active Directory (Azure AD).

Bime integreren met Azure AD biedt Hallo volgende voordelen:

- U kunt beheren in Azure AD die tooBime toegang heeft
- U kunt uw gebruikers tooautomatically get aangemelde tooBime (Single Sign-On) met hun Azure AD-accounts inschakelen
...
Azure AD-integratie met Bime tooconfigure, moet u Hallo volgende items:
...
1. Het toevoegen van Bime van Hallo-galerie
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-bime-from-hello-gallery"></a>Het toevoegen van Bime van Hallo-galerie
tooconfigure hello integratie van Bime in Azure AD, moet u tooadd Bime uit Hallo galerie tooyour lijst met beheerde SaaS-apps.

**tooadd Bime via Hallo gallery uitvoeren Hallo stappen te volgen:**
...
4. Typ in het zoekvak Hallo **Bime**.

    ![Een Azure AD-testgebruiker maken](./media/active-directory-saas-bime-tutorial/tutorial_bime_search.png)

5. Selecteer in het deelvenster resultaten hello, **Bime**, en klik vervolgens op **toevoegen** knop tooadd Hallo-toepassing.
...
Voor één aanmelding toowork moet Azure AD tooknow welke Hallo equivalent in Bime is tooa gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker Hallo in Bime toobe tot stand gebracht.

Wijs in Bime, Hallo-waarde van Hallo **gebruikersnaam** in Azure AD als waarde Hallo Hallo **gebruikersnaam** tooestablish Hallo koppeling relatie.

tooconfigure en eenmalige aanmelding Azure AD-test met Bime, moet u toocomplete Hallo bouwstenen te volgen:

1. **[Configureren van Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)**  -tooenable uw toouse gebruikers deze functie.
2. **[Maken van een Azure AD-testgebruiker](#creating-an-azure-ad-test-user)**  -tootest Azure AD eenmalige aanmelding met Britta Simon.
3. **[Maken van een testgebruiker Bime](#creating-a-bime-test-user)**  -toohave een equivalent van Britta Simon in Bime die is gekoppeld toohello Azure AD-weergave van de gebruiker.
4. **[Toewijzen hello Azure AD-testgebruiker](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD eenmalige aanmelding.
5. **[Testen van eenmalige aanmelding](#testing-single-sign-on)**  -tooverify Hallo of configuratie werkt.

### <a name="configuring-azure-ad-single-sign-on"></a>Eenmalige aanmelding Azure AD configureren

In dit gedeelte Azure AD eenmalige aanmelding inschakelen in hello Azure-portal en eenmalige aanmelding in uw toepassing Bime configureren.

**Azure AD tooconfigure eenmalige aanmelding met Bime, Voer Hallo stappen te volgen:**

1. In de Azure-portal op Hallo Hallo **Bime** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op Hallo **Bime domein en de URL's** sectie, voert u Hallo stappen te volgen:

    ![Eenmalige aanmelding configureren](./media/active-directory-saas-bime-tutorial/tutorial_bime_url.png)

    a. In Hallo **aanmeldings-URL** textbox, typ een URL met Hallo patroon volgen:`https://<tenant-name>.Bimeapp.com`

    b. In Hallo **id** textbox, typ een URL met Hallo patroon volgen:`https://<tenant-name>.Bimeapp.com`

    > [!NOTE] 
    > Deze waarden zijn niet echt. Bijwerken van deze waarden Hello werkelijke aanmeldings-URL en -id. Neem contact op met [Bime Client ondersteuningsteam](https://bime.zendesk.com/hc/categories/202604307-Support-tech-notes-and-tips-) tooget deze waarden. 
...
6. Op Hallo **Bime configuratie** sectie, klikt u op **configureren Bime** tooopen **eenmalige aanmelding configureren** venster. Kopiëren Hallo **SAML Single Sign-On Service-URL** van Hallo **Naslaggids punt.**
...
8. Klik in de werkbalk Hallo op **Admin**, en vervolgens **Account**.
   
    ![Beheerder](./media/active-directory-saas-bime-tutorial/ic775558.png "Admin")

9. Voer op Hallo account de configuratiepagina Hallo stappen te volgen:
...
In de volgorde tooenable Azure AD gebruikers toolog in tooBime, moeten ze worden ingericht in Bime. In geval van Bime Hallo is inrichting een handmatige taak.

**tooconfigure gebruikers inrichten, Voer Hallo stappen te volgen:**

1. Meld u bij tooyour **Bime** tenant.

2. Klik in de werkbalk Hallo op **Admin**, en vervolgens **gebruikers**.
   
    ![Beheerder](./media/active-directory-saas-bime-tutorial/ic775561.png "Admin")

3. In Hallo **gebruikerslijst**, klikt u op **nieuwe gebruiker toevoegen** ('+').
   
    ![Gebruikers](./media/active-directory-saas-bime-tutorial/ic775562.png "gebruikers")

4. Op Hallo **Gebruikersdetails** dialoogvenster pagina, voert u Hallo stappen te volgen:
...
>[!NOTE]
>U kunt andere Bime gebruiker account hulpmiddelen voor het maken of API's die worden geleverd door Bime tooprovision AAD-gebruikersaccounts.
>  

### <a name="assigning-hello-azure-ad-test-user"></a>Toewijzen van de testgebruiker hello Azure AD

In deze sectie kunt u Britta Simon toouse Azure eenmalige aanmelding inschakelen tooBime toegang verleent.

![Gebruiker toewijzen][200] 

**tooassign Britta Simon tooBime, Voer Hallo stappen te volgen:**

1. In hello Azure-portal, Hallo toepassingen weergeven, openen en vervolgens toohello directoryweergave navigeren en ga te**bedrijfstoepassingen** klikt u vervolgens op **alle toepassingen**.

    ![Gebruiker toewijzen][201] 

2. Selecteer in de lijst met de toepassingen van Hallo **Bime**.
...
Als u op Hallo Bime tegel in Hallo Toegangsvenster, krijgt u automatisch aangemelde tooyour Bime toepassing.
