...
2.  <span data-ttu-id="7adc2-126">Type`dsregcmd.exe /debug /leave`</span><span class="sxs-lookup"><span data-stu-id="7adc2-126">Type `dsregcmd.exe /debug /leave`</span></span>
