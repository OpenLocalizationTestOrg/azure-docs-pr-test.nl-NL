...
Microsoft-Teams is sterk afhankelijk van Exchange Online en SharePoint Online voor core productiviteit scenario's, zoals vergaderingen, agenda's en bestanden delen. Beleid voor voorwaardelijke toegang die zijn ingesteld voor deze cloud-apps van toepassing op Microsoft-Teams wanneer een gebruiker zich aanmeldt.

Microsoft-Teams wordt ook ondersteund afzonderlijk als een cloud-app in Azure Active Directory-beleid voor voorwaardelijke toegang. Certificaat-instantie beleidsregels die zijn ingesteld voor een cloud-app van toepassing op Microsoft-Teams wanneer een gebruiker zich aanmeldt.
