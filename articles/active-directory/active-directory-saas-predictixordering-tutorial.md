...
In deze zelfstudie leert u hoe toointegrate Predictix ordening met Azure Active Directory (Azure AD).

Predictix ordening integreren met Azure AD biedt Hallo volgende voordelen:

- U kunt beheren in Azure AD wie toegang tot tooPredictix heeft volgorde.
- U kunt uw gebruikers tooautomatically get aangemelde tooPredictix inschakelen volgorde (Single Sign-On) met hun Azure AD-accounts.
...
Azure AD-integratie met Predictix ordening tooconfigure, moet u Hallo volgende items:
...
1. Het toevoegen van Predictix ordening van Hallo-galerie
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-predictix-ordering-from-hello-gallery"></a>Het toevoegen van Predictix ordening van Hallo-galerie
tooconfigure hello integratie van Predictix ordening in Azure AD, moet u tooadd Predictix ordening van Hallo galerie tooyour lijst met beheerde SaaS-apps.

**tooadd Predictix bestellen via Hallo gallery uitvoeren Hallo stappen te volgen:**
...
4. Typ in het zoekvak Hallo **Predictix ordening**, selecteer **Predictix ordening** van resultaat deelvenster klik vervolgens op **toevoegen** knop tooadd Hallo-toepassing.
...
Voor één aanmelding toowork moet Azure AD tooknow welke Hallo equivalent in volgorde van Predictix is tooa gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de verwante gebruiker Hallo in volgorde van Predictix toobe tot stand gebracht.

Wijs in het Predictix ordenen wordt Hallo-waarde van Hallo **gebruikersnaam** in Azure AD als waarde Hallo Hallo **gebruikersnaam** tooestablish Hallo koppeling relatie.

tooconfigure en eenmalige aanmelding Azure AD-test met Predictix ordening, moet u toocomplete Hallo bouwstenen te volgen:
...
3. **[Maak een testgebruiker Predictix ordening](#create-a-predictix-ordering-test-user)**  -toohave een equivalent van Britta Simon in Predictix volgorde die is gekoppeld toohello Azure AD-weergave van de gebruiker.
...
In dit gedeelte Azure AD eenmalige aanmelding inschakelen in hello Azure-portal en eenmalige aanmelding configureren in uw toepassing Predictix bestellen.

**Azure AD tooconfigure eenmalige aanmelding met het bestellen van Predictix uitvoeren Hallo stappen te volgen:**

1. In Azure-portal op Hallo Hallo **Predictix ordening** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op Hallo **Predictix ordening domein en de URL's** sectie, voert u Hallo stappen te volgen:
    ...
    a. In Hallo **aanmeldings-URL** textbox, typ een URL met Hallo patroon volgen:`https://<companyname-pricing>.ordering.predictix.com/sso/request`
    ...
    > [!NOTE] 
    > Deze waarden zijn niet echt. Bijwerken van deze waarden Hello werkelijke aanmeldings-URL en -id. Neem contact op met [Predictix ordening Client ondersteuningsteam](https://www.predix.io/support/) tooget deze waarden. 
...
6. Op Hallo **Predictix ordening configuratie** sectie, klikt u op **Predictix ordening configureren** tooopen **eenmalige aanmelding configureren** venster. Kopiëren Hallo **Sign-Out-URL, SAML entiteit-ID en SAML Single Sign-On Service-URL** van Hallo **Naslaggids punt.**
...
In deze sectie maakt maken u een gebruiker Britta Simon in Predictix volgorde aangeroepen. Werken met [ondersteuningsteam Predictix ordening](https://www.predix.io/support/) tooadd Hallo gebruikers in Hallo Predictix ordening platform.

### <a name="assign-hello-azure-ad-test-user"></a>Toewijzen van de testgebruiker hello Azure AD

In deze sectie u Britta Simon toouse Azure eenmalige aanmelding inschakelen door het verlenen van toegang tooPredictix volgorde.

![Hallo-gebruikersrollen toewijzen][200] 

**tooassign Britta Simon tooPredictix ordenen wordt Hallo stappen uitvoeren:**

1. In hello Azure-portal, Hallo toepassingen weergeven, openen en vervolgens toohello directoryweergave navigeren en ga te**bedrijfstoepassingen** klikt u vervolgens op **alle toepassingen**.

    ![Gebruiker toewijzen][201] 

2. Selecteer in de lijst met de toepassingen van Hallo **Predictix ordening**.
...
Als u op Hallo Predictix ordening tegel in Hallo Toegangsvenster, krijgt u automatisch aangemelde tooyour Predictix ordening toepassing.
