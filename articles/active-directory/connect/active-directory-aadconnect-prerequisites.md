...
* Azure AD Connect is standaard TLS 1.0 gebruikt om te communiceren met Azure AD. U kunt dit wijzigen in TLS 1.2 volgens de stappen in [TLS 1.2 inschakelen voor Azure AD Connect](#enable-tls-12-for-azure-ad-connect).
