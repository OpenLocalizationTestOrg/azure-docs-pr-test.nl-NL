...
## <a name="sign-in-failure-reasons-on-the-azure-active-directory-admin-center"></a>Aanmelding mislukt redenen op het Azure Active Directory-beheercentrum

Een goede plaats om te beginnen met het oplossen van gebruiker aanmeldingsproblemen naadloze aanmelding bij is om te kijken naar de [aanmeldingsactiviteiten rapport](../active-directory-reporting-activity-sign-ins.md) op de [Azure Active Directory-beheercentrum](https://aad.portal.azure.com/).
