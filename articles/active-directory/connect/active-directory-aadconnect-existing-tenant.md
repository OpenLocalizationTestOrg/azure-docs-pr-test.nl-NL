...
Gebruikers hebben meestal userPrincipalName zowel proxyAddresses, zodat u eenvoudig de overeenkomst. Maar andere objecten, zoals beveiligingsgroepen, die niet zijn. U kunt in dit geval wordt alleen gezocht op een vaste overeenkomst met de sourceAnchor. De sourceAnchor is altijd de Base64 geconverteerd **objectGUID** op locatie, zodat u de waarde moet bijwerken in Azure AD wanneer u moet twee objecten moet worden gezocht. De sourceAnchor/onveranderbare id genoemd, kunnen alleen worden bijgewerkt met PowerShell en niet via de portals.
