...
In deze zelfstudie leert u hoe toointegrate Zscaler ZSCloud met Azure Active Directory (Azure AD).

Zscaler ZSCloud integreren met Azure AD biedt Hallo volgende voordelen:

- U kunt beheren in Azure AD wie toegang tot tooZscaler ZSCloud heeft
- U kunt uw gebruikers tooautomatically get aangemelde tooZscaler ZSCloud (Single Sign-On) met hun Azure AD-accounts inschakelen
...
Azure AD-integratie met Zscaler ZSCloud tooconfigure, moet u Hallo volgende items:
...
1. Het toevoegen van Zscaler ZSCloud van Hallo-galerie
2. Configureren en testen van Azure AD eenmalige aanmelding

## <a name="adding-zscaler-zscloud-from-hello-gallery"></a>Het toevoegen van Zscaler ZSCloud van Hallo-galerie
tooconfigure hello integratie van Zscaler ZSCloud in Azure AD, moet u tooadd Zscaler ZSCloud uit Hallo galerie tooyour lijst met beheerde SaaS-apps.

**tooadd Zscaler ZSCloud via Hallo gallery uitvoeren Hallo stappen te volgen:**
...
4. Typ in het zoekvak Hallo **Zscaler ZSCloud**.

    ![Een Azure AD-testgebruiker maken](./media/active-directory-saas-zscaler-zscloud-tutorial/tutorial_zscalerzscloud_search.png)

5. Selecteer in het deelvenster resultaten hello, **Zscaler ZSCloud**, en klik vervolgens op **toevoegen** knop tooadd Hallo-toepassing.
...
Voor één aanmelding toowork moet Azure AD tooknow welke Hallo equivalent in Zscaler ZSCloud is tooa gebruiker in Azure AD. Met andere woorden, moet een koppeling relatie tussen een Azure AD-gebruiker en de betreffende gebruiker Hallo in Zscaler ZSCloud toobe tot stand gebracht.

Deze relatie koppeling wordt vastgesteld door het toewijzen van de waarde van Hallo Hallo **gebruikersnaam** in Azure AD als waarde Hallo Hallo **gebruikersnaam** in Zscaler ZSCloud.
...
3. **[Maken van een testgebruiker Zscaler ZSCloud](#creating-a-zscaler-zscloud-test-user)**  -toohave een equivalent van Britta Simon in Zscaler ZSCloud die is gekoppeld toohello Azure AD-weergave van de gebruiker.
4. **[Toewijzen hello Azure AD-testgebruiker](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD eenmalige aanmelding.
5. **[Testen van eenmalige aanmelding](#testing-single-sign-on)**  -tooverify Hallo of configuratie werkt.

### <a name="configuring-azure-ad-single-sign-on"></a>Eenmalige aanmelding Azure AD configureren

In dit gedeelte Azure AD eenmalige aanmelding inschakelen in hello Azure-portal en eenmalige aanmelding in uw toepassing Zscaler ZSCloud configureren.

**Azure AD tooconfigure eenmalige aanmelding met Zscaler ZSCloud, Voer Hallo stappen te volgen:**

1. In de Azure-portal op Hallo Hallo **Zscaler ZSCloud** toepassing Integratiepagina, klikt u op **eenmalige aanmelding**.
...
3. Op Hallo **Zscaler ZSCloud domein en de URL's** sectie, voert u Hallo stappen te volgen:

    ![Eenmalige aanmelding configureren](./media/active-directory-saas-zscaler-zscloud-tutorial/tutorial_zscalerzscloud_url.png)

     In Hallo **aanmeldings-URL** textbox type Hallo-URL die door uw gebruikers toosign op tooyour ZScaler ZSCloud toepassing gebruikt.
    
    > [!NOTE] 
    > U hebt tooupdate deze waarde Hello werkelijke aanmeldings-URL. Neem contact op met [Zscaler ZSCloud Client ondersteuningsteam](https://support.zscaler.com/hc/articles/210172606-Zscaler-is-Expanding-Its-Zscloud-Global-Footprint) tooget deze waarde. 
...
6. Op Hallo **Zscaler ZSCloud configuratie** sectie, klikt u op **configureren Zscaler ZSCloud** tooopen **eenmalige aanmelding configureren** venster. Kopiëren Hallo **SAML Single Sign-On Service-URL** van Hallo **Naslaggids punt.**
...
7. In een ander browservenster aanmelden tooyour ZScaler ZSCloud bedrijf site als beheerder.
...
11. Op Hallo **configureren SAML Single Sign-On Parameters** dialoogvenster pagina Hallo volgende stappen uit te voeren en klik vervolgens op **gedaan**
    ...
    a. Plakken Hallo **SAML Single Sign-On Service-URL** waarde in Hallo **URL Hallo SAML Portal toowhich gebruikers worden verzonden voor verificatie** textbox.
...
Azure AD tooenable gebruikers toolog in tooZScaler ZSCloud, moeten ze ingerichte tooZScaler ZSCloud.  
In geval van ZScaler ZSCloud Hallo is inrichting een handmatige taak.
...
> [!NOTE]
> U kunt andere ZScaler ZSCloud gebruiker account hulpmiddelen voor het maken of API's die worden geleverd door ZScaler ZSCloud tooprovision AAD-gebruikersaccounts.

### <a name="assigning-hello-azure-ad-test-user"></a>Toewijzen van de testgebruiker hello Azure AD

In deze sectie kunt u Britta Simon toouse Azure eenmalige aanmelding inschakelen door het verlenen van toegang tooZscaler ZSCloud.

![Gebruiker toewijzen][200] 

**tooassign Britta Simon tooZscaler ZSCloud, Voer Hallo stappen te volgen:**

1. In hello Azure-portal, Hallo toepassingen weergeven, openen en vervolgens toohello directoryweergave navigeren en ga te**bedrijfstoepassingen** klikt u vervolgens op **alle toepassingen**.

    ![Gebruiker toewijzen][201] 

2. Selecteer in de lijst met de toepassingen van Hallo **Zscaler ZSCloud**.
...
Als u op Hallo Zscaler ZSCloud-tegel in Hallo Toegangsvenster, krijgt u automatisch aangemelde tooyour Zscaler ZSCloud toepassing.
