...
2. De service voor toepassingsproxy evalueert het token. Dit zorgt ervoor dat de gebruiker in de tenant die het token is uitgegeven voor de beheerder is. Als de gebruiker geen beheerder is, wordt het proces beëindigd.
