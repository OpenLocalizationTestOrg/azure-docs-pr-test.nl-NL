...
Onder **selecteert u virtuele machines om vrij te geven**, selecteer een of meer Azure virtual machines vrijgeven.

![](./media/automation-dsc-onboarding/DSC_Onboarding_2.png)

Onder **registratiegegevens configureren**, voer de [PowerShell DSC Local Configuration Manager-waarden](https://msdn.microsoft.com/powershell/dsc/metaconfig4) vereist is voor uw gebruiksvoorbeeld, en desgewenst een knooppuntconfiguratie toewijzen aan de virtuele machine.
...
5. Voer het script. U hebt nu een map met de naam **DscMetaConfigs** die in uw werkmap, bevat de PowerShell DSC-metaconfigurations voor de machines voorbereiden (als administrator):
