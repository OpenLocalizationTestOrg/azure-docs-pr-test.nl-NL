...
1. In de klassieke Azure-portal klikt, **nieuw**, **App Services**, **Automation**, **Runbook**, **snelle invoer**.
...
U kunt een nieuw runbook maken in Azure Automation via een PowerShell-script of PowerShell-werkstroom (.ps1 extensie) of een geëxporteerde grafisch runbook (.graphrunbook) importeren.  Geef de [type runbook](automation-runbook-types.md) die wordt gemaakt van de import rekening houdend met de volgende overwegingen.
...
1. Selecteer in de Azure-beheerportal, **Automation** en selecteer vervolgens een Automation-Account.
2. Klik op **Import**.
...
5. De nieuwe runbook wordt weergegeven op de **Runbooks** tabblad voor het Automation-Account.
...
7. De nieuwe runbook wordt weergegeven in de lijst met runbooks voor het Automation-Account.
8. U moet [het runbook gepubliceerd](#publishing-a-runbook) voordat u deze kunt uitvoeren.

> [!NOTE]
> Als u een grafisch runbook of een grafische PowerShell workflow-runbook importeert, hebt u de optie om te converteren naar het andere type desgewenst. U kan niet converteren naar tekst.
> 
> 
...
U kunt de [importeren AzureRMAutomationRunbook](https://msdn.microsoft.com/library/mt603735.aspx) cmdlet om een scriptbestand importeren als een PowerShell Workflow-runbook-concept. Als het runbook al bestaat, mislukt het importeren tenzij u de *-Force* parameter. 
...
## <a name="to-publish-a-runbook-using-the-azure-classic-portal"></a>Een runbook met de klassieke Azure-portal publiceren
