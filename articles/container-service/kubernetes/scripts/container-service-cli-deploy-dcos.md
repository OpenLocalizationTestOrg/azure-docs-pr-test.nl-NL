...
---
# <a name="create-an-azure-container-service-dcos-cluster"></a>Een Azure Container Service DC/OS-Cluster maken

In dit voorbeeld wordt een Azure Container Service-cluster DCOS uitgevoerd.
