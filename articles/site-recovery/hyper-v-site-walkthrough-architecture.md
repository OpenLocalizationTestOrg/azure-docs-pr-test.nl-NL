...
---
# <a name="step-1-review-hello-architecture-for-hyper-v-replication-tooazure"></a>Stap 1: Bekijk Hallo-architectuur voor Hyper-V-replicatie tooAzure


Dit artikel wordt beschreven Hallo-onderdelen en processen die betrokken zijn bij het repliceren van on-premises Hyper-V virtuele machines (die niet worden beheerd door System Center VMM), met behulp van Hallo tooAzure [Azure Site Recovery](site-recovery-overview.md) service.
...
Er zijn een aantal onderdelen betrokken bij het repliceren van Hyper-V-machines tooAzure zonder VMM.
...
**Hyper-V** | Hosts en clusters van Hyper-V worden verzameld in Hyper-V-sites. Hello Azure Site Recovery Provider en de Recovery Services-agent is geïnstalleerd op elke Hyper-V-host. | Hallo Provider stuurt replicatie met Site Recovery via Hallo internet. Hallo Recovery Services-agent verwerkt de gegevensreplicatie.<br/><br/> Communicatie van zowel Hallo Provider en Hallo-agent is beveiligd en versleuteld. De gerepliceerde gegevens in de Azure-opslag zijn eveneens versleuteld.
...
4. U kunt bewaken Hallo taak in Hallo **taken** tabblad.
...
Ga te[stap 2: Controleer Hallo-vereisten voor implementatie](hyper-v-site-walkthrough-prerequisites.md)
