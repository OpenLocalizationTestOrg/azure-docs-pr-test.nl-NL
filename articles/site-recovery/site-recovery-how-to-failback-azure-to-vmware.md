...
* U kunt niet weer alleen aan een virtuele machine file system (VMFS) gegevensarchief. Als u een virtueel SAN of RDM hebt, werkt beveiligt en failback niet.
...
* U afkeuren terug naar vSAN of RDM gebaseerde schijven niet. Nieuwe virtuele machine-schijven (VMDKs) kunnen alleen worden gemaakt op een gegevensopslag VMFS.
