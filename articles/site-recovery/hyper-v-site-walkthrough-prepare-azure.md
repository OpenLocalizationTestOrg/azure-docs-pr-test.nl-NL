...
---
# <a name="step-5-prepare-azure-resources-for-hyper-v-replication-tooazure"></a>Stap 5: Azure-resources voor Hyper-V-replicatie tooAzure voorbereiden

Gebruik Hallo-instructies in dit artikel tooprepare Azure zodat u kunt repliceren lokale Hyper-V-machines (zonder de System Center VMM) met behulp van Hallo tooAzure [Azure Site Recovery](site-recovery-overview.md) service.
...
Zorg ervoor dat u hebt Hallo gelezen [vereisten](hyper-v-site-walkthrough-prerequisites.md)
...
Ga te[stap 6: Hyper-V voorbereiden resources](hyper-v-site-walkthrough-prepare-hyper-v.md)
