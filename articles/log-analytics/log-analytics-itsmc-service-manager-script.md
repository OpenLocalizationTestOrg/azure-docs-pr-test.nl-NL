---
title: aaaAutomated script toocreate webinhoud Service Manager-app tooconnect met IT Service Management-Connector in OMS | Microsoft Docs
description: Maken van een Service Manager-Web-app met behulp van een geautomatiseerd script tooconnect met IT Service Management-Connector in OMS, centraal bewaken en beheren van Hallo ITSM werkitems.
...
---
# <a name="create-service-manager-web-app-using-hello-automated-script-preview"></a><span data-ttu-id="58ebe-103">Service Manager-Web-app met behulp van automatische Hallo-script (Preview) maken</span><span class="sxs-lookup"><span data-stu-id="58ebe-103">Create Service Manager Web app using hello automated script (Preview)</span></span>

<span data-ttu-id="58ebe-104">Gebruik Hallo script toocreate Hallo Web-app voor uw Service Manager-exemplaar te volgen.</span><span class="sxs-lookup"><span data-stu-id="58ebe-104">Use hello following script toocreate hello Web app for your Service Manager instance.</span></span> <span data-ttu-id="58ebe-105">Meer informatie over Service Manager-verbinding is hier: [Service Manager-Web-app](log-analytics-itsmc-connections.md#create-and-deploy-service-manager-web-app-service)</span><span class="sxs-lookup"><span data-stu-id="58ebe-105">More information about Service Manager connection is here: [Service Manager Web app](log-analytics-itsmc-connections.md#create-and-deploy-service-manager-web-app-service)</span></span>

<span data-ttu-id="58ebe-106">Hallo-script uitvoeren door te geven Hallo vereiste gegevens te volgen:</span><span class="sxs-lookup"><span data-stu-id="58ebe-106">Run hello script by providing hello following required details:</span></span>

- <span data-ttu-id="58ebe-107">Details van de Azure-abonnement</span><span class="sxs-lookup"><span data-stu-id="58ebe-107">Azure subscription details</span></span>
- <span data-ttu-id="58ebe-108">De naam van resourcegroep</span><span class="sxs-lookup"><span data-stu-id="58ebe-108">Resource group name</span></span>
- <span data-ttu-id="58ebe-109">Locatie</span><span class="sxs-lookup"><span data-stu-id="58ebe-109">Location</span></span>
- <span data-ttu-id="58ebe-110">Details van Service Manager-server (server name, domein, gebruikersnaam en wachtwoord)</span><span class="sxs-lookup"><span data-stu-id="58ebe-110">Service Manager server details (server name,    domain, username and password)</span></span>
- <span data-ttu-id="58ebe-111">Site-voorvoegsel voor uw Web-app</span><span class="sxs-lookup"><span data-stu-id="58ebe-111">Site name prefix for your Web app</span></span>
- <span data-ttu-id="58ebe-112">Service Bus-Namespace.</span><span class="sxs-lookup"><span data-stu-id="58ebe-112">ServiceBus Namespace.</span></span>

<span data-ttu-id="58ebe-113">Hallo script wordt Hallo Web-app maken met behulp van Hallo-naam die u hebt opgegeven (samen met enkele extra tekenreeksen toomake deze unieke).</span><span class="sxs-lookup"><span data-stu-id="58ebe-113">hello script will create hello Web app using hello name that you specified (along with few additional strings toomake it unique).</span></span> <span data-ttu-id="58ebe-114">Hallo genereert **Web-app-URL**, **client-ID** en **clientgeheim**.</span><span class="sxs-lookup"><span data-stu-id="58ebe-114">It generates hello **Web app URL**, **client ID** and **client secret**.</span></span>

<span data-ttu-id="58ebe-115">Sla deze waarden moet u deze wanneer u een verbinding met de IT-Service Management-Connector maakt.</span><span class="sxs-lookup"><span data-stu-id="58ebe-115">Save these values, you will need these when you create a connection with IT Service Management Connector.</span></span>

## <a name="prerequisites"></a><span data-ttu-id="58ebe-116">Vereisten</span><span class="sxs-lookup"><span data-stu-id="58ebe-116">Prerequisites</span></span>

 <span data-ttu-id="58ebe-117">Windows Management Framework 5.0 of hoger.</span><span class="sxs-lookup"><span data-stu-id="58ebe-117">Windows Management Framework 5.0 or above.</span></span>
<span data-ttu-id="58ebe-118">Windows 10 heeft 5.1 standaard.</span><span class="sxs-lookup"><span data-stu-id="58ebe-118">Windows 10 has 5.1 by default.</span></span> <span data-ttu-id="58ebe-119">U kunt downloaden Hallo framework van [hier](https://www.microsoft.com/download/details.aspx?id=53347):</span><span class="sxs-lookup"><span data-stu-id="58ebe-119">You can download hello framework from [here](https://www.microsoft.com/download/details.aspx?id=53347):</span></span>

<span data-ttu-id="58ebe-120">Gebruik Hallo script volgen:</span><span class="sxs-lookup"><span data-stu-id="58ebe-120">Use hello following script:</span></span>
...
```
## <a name="next-steps"></a><span data-ttu-id="58ebe-121">Volgende stappen</span><span class="sxs-lookup"><span data-stu-id="58ebe-121">Next steps</span></span>
<span data-ttu-id="58ebe-122">[Configureer de Hallo hybride verbinding](log-analytics-itsmc-connections.md#configure-the-hybrid-connection).</span><span class="sxs-lookup"><span data-stu-id="58ebe-122">[Configure hello Hybrid connection](log-analytics-itsmc-connections.md#configure-the-hybrid-connection).</span></span>
