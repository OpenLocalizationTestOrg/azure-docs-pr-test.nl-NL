...
---
# <a name="create-service-manager-web-app-using-the-automated-script-preview"></a><span data-ttu-id="43588-103">Service Manager-Web-app met behulp van de geautomatiseerde script (Preview) maken</span><span class="sxs-lookup"><span data-stu-id="43588-103">Create Service Manager Web app using the automated script (Preview)</span></span>

<span data-ttu-id="43588-104">Gebruik het volgende script te maken van de Web-app voor uw exemplaar van de Service Manager.</span><span class="sxs-lookup"><span data-stu-id="43588-104">Use the following script to create the Web app for your Service Manager instance.</span></span> <span data-ttu-id="43588-105">Meer informatie over Service Manager-verbinding is hier: [Service Manager-Web-app](log-analytics-itsmc-connections.md#create-and-deploy-service-manager-web-app-service)</span><span class="sxs-lookup"><span data-stu-id="43588-105">More information about Service Manager connection is here: [Service Manager Web app](log-analytics-itsmc-connections.md#create-and-deploy-service-manager-web-app-service)</span></span>

<span data-ttu-id="43588-106">Voer het script door de volgende vereiste gegevens:</span><span class="sxs-lookup"><span data-stu-id="43588-106">Run the script by providing the following required details:</span></span>

- <span data-ttu-id="43588-107">Details van de Azure-abonnement</span><span class="sxs-lookup"><span data-stu-id="43588-107">Azure subscription details</span></span>
- <span data-ttu-id="43588-108">De naam van resourcegroep</span><span class="sxs-lookup"><span data-stu-id="43588-108">Resource group name</span></span>
- <span data-ttu-id="43588-109">Locatie</span><span class="sxs-lookup"><span data-stu-id="43588-109">Location</span></span>
- <span data-ttu-id="43588-110">Details van Service Manager-server (server name, domein, gebruikersnaam en wachtwoord)</span><span class="sxs-lookup"><span data-stu-id="43588-110">Service Manager server details (server name,    domain, username and password)</span></span>
- <span data-ttu-id="43588-111">Site-voorvoegsel voor uw Web-app</span><span class="sxs-lookup"><span data-stu-id="43588-111">Site name prefix for your Web app</span></span>
- <span data-ttu-id="43588-112">Service Bus-Namespace.</span><span class="sxs-lookup"><span data-stu-id="43588-112">ServiceBus Namespace.</span></span>

<span data-ttu-id="43588-113">Het script maakt de Web-app met de naam die u hebt opgegeven (samen met enkele extra tekenreeksen uniek te maken).</span><span class="sxs-lookup"><span data-stu-id="43588-113">The script will create the Web app using the name that you specified (along with few additional strings to make it unique).</span></span> <span data-ttu-id="43588-114">Genereert het **Web-app-URL**, **client-ID** en **clientgeheim**.</span><span class="sxs-lookup"><span data-stu-id="43588-114">It generates the **Web app URL**, **client ID** and **client secret**.</span></span>

<span data-ttu-id="43588-115">Sla deze waarden moet u deze wanneer u een verbinding met de IT-Service Management-Connector maakt.</span><span class="sxs-lookup"><span data-stu-id="43588-115">Save these values, you will need these when you create a connection with IT Service Management Connector.</span></span>

## <a name="prerequisites"></a><span data-ttu-id="43588-116">Vereisten</span><span class="sxs-lookup"><span data-stu-id="43588-116">Prerequisites</span></span>

 <span data-ttu-id="43588-117">Windows Management Framework 5.0 of hoger.</span><span class="sxs-lookup"><span data-stu-id="43588-117">Windows Management Framework 5.0 or above.</span></span>
<span data-ttu-id="43588-118">Windows 10 heeft 5.1 standaard.</span><span class="sxs-lookup"><span data-stu-id="43588-118">Windows 10 has 5.1 by default.</span></span> <span data-ttu-id="43588-119">U kunt downloaden van het framework van [hier](https://www.microsoft.com/download/details.aspx?id=53347):</span><span class="sxs-lookup"><span data-stu-id="43588-119">You can download the framework from [here](https://www.microsoft.com/download/details.aspx?id=53347):</span></span>

<span data-ttu-id="43588-120">Gebruik het volgende script:</span><span class="sxs-lookup"><span data-stu-id="43588-120">Use the following script:</span></span>
...
```
## <a name="next-steps"></a><span data-ttu-id="43588-121">Volgende stappen</span><span class="sxs-lookup"><span data-stu-id="43588-121">Next steps</span></span>
<span data-ttu-id="43588-122">[Configureer de hybride verbinding](log-analytics-itsmc-connections.md#configure-the-hybrid-connection).</span><span class="sxs-lookup"><span data-stu-id="43588-122">[Configure the Hybrid connection](log-analytics-itsmc-connections.md#configure-the-hybrid-connection).</span></span>
