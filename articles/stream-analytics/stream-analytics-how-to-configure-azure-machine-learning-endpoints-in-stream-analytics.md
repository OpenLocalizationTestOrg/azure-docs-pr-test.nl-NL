...
Elk eindpunt heeft API's voor Batchuitvoering en synchrone uitvoering. Stream Analytics gebruikt synchrone uitvoering. De specifieke service heet een [aanvraag/antwoord-Service](../machine-learning/machine-learning-consume-web-services.md) in AzureML studio.
