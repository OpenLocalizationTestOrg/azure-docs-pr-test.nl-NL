...
In dit artikel lijsten Hallo verschillende servers en werkbelastingen die u met Azure Backup-Server beveiligen kunt. Hallo volgende matrix geeft een lijst wat kan worden beveiligd met Azure Backup-Server v1- en v2.
...
|Clientcomputers (64-bits en 32-bits)|Windows 10|Fysieke server<br /><br />Virtuele Hyper-V-machine <br /><br />Virtuele VMware-machine|J|J|Bestanden<br /><br />Beveiligde volumes moeten NTFS zijn. FAT en FAT32 worden niet ondersteund.<br /><br />Volumes moeten ten minste 1 GB. DPM gebruikt de momentopname van de Volume Shadow Copy Service (VSS) tootake Hallo-gegevens en Hallo momentopname werkt alleen als Hallo volume minstens 1 GB.|
|Clientcomputers (64-bits en 32-bits)|Windows 8.1|Fysieke server<br /><br />Virtuele Hyper-V-machine |J|J|Bestanden<br /><br />Beveiligde volumes moeten NTFS zijn. FAT en FAT32 worden niet ondersteund.<br /><br />Volumes moeten ten minste 1 GB. DPM gebruikt de momentopname van de Volume Shadow Copy Service (VSS) tootake Hallo-gegevens en Hallo momentopname werkt alleen als Hallo volume minstens 1 GB.|
...
|Servers (32-bits en 64-bits)|Windows Server 2012 R2 - Datacenter en Standard|Azure virtuele machine (indien de werkbelasting wordt uitgevoerd als Azure virtuele machine)|J|J |Volume, share, map, bestand<br /><br />DPM moet worden uitgevoerd op ten minste Windows Server 2012 R2 tooprotect Windows Server 2012 ontdubbelde volumes.|
|Servers (32-bits en 64-bits)|Windows Server 2012 R2 - Datacenter en Standard|Windows virtuele machine in VMWare (beveiligt werkbelasting die wordt uitgevoerd in Windows virtuele machine in VMWare)|J|J|Volume, share, map, bestand, systeemstatus/bare metal)<br /><br />DPM moet worden uitgevoerd op Windows Server 2012 of 2012 R2 tooprotect Windows Server 2012 ontdubbelde volumes.|
|Servers (32-bits en 64-bits)|Windows Server 2012/2012 met SP1 - Datacenter en Standard|Fysieke server<br /><br />On-premises Hyper-V virtuele machine|J|J|Volume, share, map, bestand, systeemstatus/bare metal<br /><br />DPM moet worden uitgevoerd op ten minste Windows Server 2012 R2 tooprotect Windows Server 2012 ontdubbelde volumes.|
|Servers (32-bits en 64-bits)|Windows Server 2012/2012 met SP1 - Datacenter en Standard|Azure virtuele machine (indien de werkbelasting wordt uitgevoerd als Azure virtuele machine)|J|J|Volume, share, map, bestand<br /><br />DPM moet worden uitgevoerd op ten minste Windows Server 2012 R2 tooprotect Windows Server 2012 ontdubbelde volumes.|
|Servers (32-bits en 64-bits)|Windows Server 2012/2012 met SP1 - Datacenter en Standard|Windows virtuele machine in VMWare (beveiligt werkbelasting die wordt uitgevoerd in Windows virtuele machine in VMWare)|J|J|Volume, share, map, bestand, systeemstatus/bare metal<br /><br />DPM moet worden uitgevoerd op ten minste Windows Server 2012 R2 tooprotect Windows Server 2012 ontdubbelde volumes.|
|Servers (32-bits en 64-bits)|Windows Server 2008 R2 SP1 - Standard en Enterprise|Fysieke server<br /><br />On-premises Hyper-V virtuele machine|J<br /><br />U moet toobe met SP1 en installatie [Windows Management Frame 4.0](https://www.microsoft.com/en-us/download/details.aspx?id=40855)|J|Volume, share, map, bestand, systeemstatus/bare metal|
|Servers (32-bits en 64-bits)|Windows Server 2008 R2 SP1 - Standard en Enterprise|Azure virtuele machine (indien de werkbelasting wordt uitgevoerd als Azure virtuele machine)|J<br /><br />U moet toobe met SP1 en installatie [Windows Management Frame 4.0](https://www.microsoft.com/en-us/download/details.aspx?id=40855)|J |Volume, share, map, bestand|
|Servers (32-bits en 64-bits)|Windows Server 2008 R2 SP1 - Standard en Enterprise|Windows virtuele machine in VMWare (beveiligt werkbelasting die wordt uitgevoerd in Windows virtuele machine in VMWare)|J<br /><br />U moet toobe met SP1 en installatie [Windows Management Frame 4.0](https://www.microsoft.com/en-us/download/details.aspx?id=40855)|J |Volume, share, map, bestand, systeemstatus/bare metal|
...
Azure Backup-Server kan gegevens in de volgende geclusterde toepassingen Hallo beveiligen:

-   Bestandsservers

-   SQL Server

-   Hyper-V - als u een Hyper-V-cluster met uitgebreide DPM-beveiliging beveiligt, kunt u secundaire beveiliging voor Hyper-V-werkbelastingen beveiligd Hallo toevoegen.

    Als u Hyper-V op Windows Server 2008 R2 uitvoert, controleert u of tooinstall Hallo update wordt beschreven in KB [975354](https://support.microsoft.com/en-us/kb/975354).
...
Azure Backup-Server kan cluster werkbelastingen beveiligen die zich in Hallo bevinden hetzelfde domein als de DPM-server hello en in een onderliggend of vertrouwd domein. Als u de gegevensbronnen tooprotect in niet-vertrouwde domeinen of werkgroepen wilt, verificatie van NTLM of certificaatverificatie voor één server of verificatie via certificaat alleen gebruiken voor een cluster.
