...
### [Limieten en configuratie](logic-apps-limits-and-config.md)
...
### [Status van logische apps bewaken](logic-apps-monitor-your-logic-apps.md)
### [Status van logische apps in OMS bewaken met Log Analytics](logic-apps-monitor-your-logic-apps-oms.md)
