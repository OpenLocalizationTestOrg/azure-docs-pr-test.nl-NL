...
> [!NOTE] 
> U kunt zowel gebruikers als andere groepen toevoegen aan een groep in Azure AD met behulp van de Azure-portal. Echter, om een service-principal toevoegt aan een groep, gebruik [Azure AD PowerShell-module](../active-directory/active-directory-accessmanagement-groups-settings-v2-cmdlets.md).
> 
> ```powershell
