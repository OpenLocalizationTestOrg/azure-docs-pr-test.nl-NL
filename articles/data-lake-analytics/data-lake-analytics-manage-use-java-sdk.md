...
* **IntelliJ** of een andere geschikte Java-ontwikkelomgeving. Hallo-instructies in dit document wordt IntelliJ gebruikt.
* Maak een Azure Active Directory (AAD)-toepassing en haal de **Client-ID**, **Tenant-ID**, en **sleutel** ervan op. Voor meer informatie over AAD-toepassingen en instructies over het tooget een client-ID, Zie [een Active Directory-toepassing en service-principal maken met portal](../azure-resource-manager/resource-group-create-service-principal-portal.md). Hallo antwoord-URI en sleutel is beschikbaar via de portal Hallo zodra u hebt Hallo toepassing gemaakt en sleutel gegenereerd.

## <a name="authenticating-using-azure-active-directory"></a>Verificatie met Azure Active Directory

Hallo code volgende codefragment vindt u code voor **niet-interactieve** verificatie, waarbij Hallo toepassing eigen referenties verstrekt.

## <a name="create-a-java-application"></a>Een Java-toepassing maken
1. Open IntelliJ en maak een Java-project met behulp van Hallo **Command-Line App** sjabloon.
...
Ga te**bestand > Instellingen > samenstellen > uitvoering > implementatie**. Selecteer **Build Tools > Maven > importeren**. Controleer vervolgens **Import Maven projects automatisch**.

Open `Main.java` en vervang Hallo bestaande codeblok Hello codefragment te volgen:
...
Hallo-waarden opgeven voor parameters die in het codefragment Hallo genoemd:
* `localFolderPath`
* `_adlaAccountName`
* `_adlsAccountName`
* `_resourceGroupName`

Vervang de tijdelijke aanduidingen Hallo voor:
* `CLIENT-ID`,
* `CLIENT-SECRET`,
* `TENANT-ID`
* `SUBSCRIPTION-ID`
