...
Als u wilt maken van een virtuele machine met een formule, gebruik de parameter van de--formule in [az lab vm maken](https://docs.microsoft.com/cli/azure/lab/vm#create).
