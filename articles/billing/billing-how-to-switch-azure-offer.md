...
description: Meer informatie over het wijzigen van uw Azure-abonnement en schakel over naar een andere aanbieding die met behulp van de beheerportal abonnement
services: 
documentationcenter: 
author: genlin
manager: jlian
...
---
# <a name="switch-your-azure-subscription-to-another-offer"></a>Uw Azure-abonnement overschakelen naar een andere aanbieding

Als een [betalen naar gebruik](https://azure.microsoft.com/offers/ms-azr-0003p/) klant, kunt u uw Azure-abonnement overschakelen naar een andere aanbieding in de [Accountcentrum](https://account.windowsazure.com/Subscriptions). Bijvoorbeeld, kunt u deze functie om te profiteren van de [maandelijks tegoed voor Visual Studio-abonnees](https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/). Als u van gebruikmaakt [gratis proefversie](https://azure.microsoft.com/free/), informatie over hoe [upgrade naar betalen per gebruik](billing-upgrade-azure-subscription.md).
...
* U bent niet op [betalen naar gebruik](https://azure.microsoft.com/offers/ms-azr-0003p/). Momenteel kunnen alleen betalen naar gebruik abonnementen worden overgeschakeld naar een andere aanbieding.
...
* Bent u niet in aanmerking komen voor geen aanbieding switches. Controleer de [lijst met beschikbare aanbiedingen die u naar overschakelen kunt](#whats-supported).
...
> [!NOTE]
> Als gevolg van beperkingen voor facturerings-gerelateerde zijn aanbieding switches niet mogelijk binnen de eerste factureringscyclus na het maken van een abonnement.
>
>
...
* Als u wilt migreren naar de CSP, Zie [Azure-Abonnementmigratie naar de CSP](https://blogs.technet.microsoft.com/hybridcloudbp/2016/08/26/azure-subscription-migration-to-csp/).
