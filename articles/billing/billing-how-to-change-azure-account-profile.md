...
1. Aanmelden bij de [Azure-Accountcentrum](https://account.windowsazure.com/) als de accountbeheerder en klik vervolgens op **profiel**. 
2. Selecteer de **details bewerken** knop, en werk vervolgens de **profiel** informatie.

   ![Profiel](./media/billing-how-to-change-azure-account-profile/profile.png)

## <a name="frequently-asked-questions"></a>Veelgestelde vragen
### <a name="can-notifications-be-sent-to-a-different-email-address-other-than-the-account-owner-email-address-associated-with-my-account"></a>Kunnen meldingen naar een ander e-mailadres worden verzonden dan het e-mailadres van de accounteigenaar die is gekoppeld aan mijn account?
...
Informatie over het bijwerken van je factureringsgegevens door te zien [wijzigen van de creditcard die is gebruikt om een Azure-abonnement te betalen](billing-how-to-change-credit-card.md).
