...
Dit script maakt van een virtuele machine en hello Azure virtuele Machine aangepast script extensie tooinstall WordPress gebruikt. Na het Hallo-script wordt uitgevoerd, u toegang hebt tot Hallo WordPress-site voor configuration op `http://<public IP of VM>/wordpress`. 
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Hallo aangepaste Scriptextensie toohello virtuele machine, die een script tooinstall WordPress roept toevoegen. |
