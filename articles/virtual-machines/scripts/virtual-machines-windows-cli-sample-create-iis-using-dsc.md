...
[!code-azurecli-interactive[belangrijkste](../../../cli_scripts/virtual-machine/create-windows-iis-using-dsc/create-windows-iis-using-dsc.sh "snelle VM maken")]
...
| [AZ vm-extensie instellen](https://docs.microsoft.com/cli/azure/vm#create) | De aangepaste Scriptextensie toevoegen aan de virtuele machine die wordt aangeroepen een script om IIS te installeren. |
