...
Dit script wordt een Azure virtuele Machine gemaakt en gebruikt vervolgens hello Azure virtuele Machine aangepaste Scriptextensie tooinstall NGINX. Na het uitvoeren van script hello, kunt u toegang tot een demo-website op Hallo openbare IP-adres van Hallo virtuele machine.
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Een VM-extensie toohello virtuele machine toevoegen. In dit voorbeeld is de aangepaste scriptextensie Hallo gebruikte tooinstall NGINX. |
