...
Maak meerdere identieke beheerde schijven van een VHD-bestand in een kleine hoeveelheid tijd. toocreate schijven die worden beheerd vanaf een vhd-bestand, blob-momentopname van Hallo vhd-bestand wordt gemaakt en wordt het gebruikte toocreate beheerd schijven. Slechts één blob momentopname kan worden gemaakt in een minuut dat ervoor zorgt het maken van schijffouten dat vanwege toothrottling. tooavoid deze beperking, maak een [beheerde momentopname van de vhd-bestand Hallo](virtual-machines-windows-powershell-sample-create-snapshot-from-vhd.md?toc=%2fpowershell%2fmodule%2ftoc.json) en vervolgens gebruik Hallo beheerd momentopname toocreate meerdere beheerde schijven in korte tijd. 
