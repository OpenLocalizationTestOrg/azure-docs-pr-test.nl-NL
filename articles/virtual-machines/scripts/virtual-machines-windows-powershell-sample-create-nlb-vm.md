...
Dit voorbeeldscript wordt gemaakt van alles wat u nodig toorun verschillende virtuele machines van Windows Server 2016 geconfigureerd in een maximaal beschikbare en load balanced configuratie. Nadat het Hallo-script wordt uitgevoerd, hebt u drie virtuele machines, gekoppelde tooan Beschikbaarheidsset Azure en zijn toegankelijk via een Azure Load Balancer.
