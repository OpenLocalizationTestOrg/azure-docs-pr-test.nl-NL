...
Dit artikel beschrijft de beschikbare grootten Hallo en opties voor hello Azure virtuele machines kunt u toorun uw Linux-apps en werkbelastingen. Het bevat ook toobe voor overwegingen met betrekking tot implementatie op de hoogte van wanneer u van plan bent toouse deze resources. In dit artikel is ook beschikbaar voor [Windows virtuele machines](../windows/sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
...
| [Geoptimaliseerde rekenkracht](sizes-compute.md)        | FS, F             | Hoge CPU-geheugenverhouding. Goede voor webservers gemiddeld verkeer, netwerkapparaten, bad processen en toepassingsservers.        |
| [Geoptimaliseerd geheugen](sizes-memory.md)         | Esv3, Ev3, M, GS, G, DSv2, DS, Dv2, D   | Verhouding tussen het hoge geheugen aan CPU. Ideaal voor relationele database-servers, gemiddeld toolarge caches en in het geheugen analytics.                 |
...
- Zie voor meer informatie over prijzen Hallo verschillende grootten [prijzen van virtuele Machines](https://azure.microsoft.com/pricing/details/virtual-machines/#Linux). 
