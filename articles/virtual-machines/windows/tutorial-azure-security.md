...
De volgende zelfstudie toolearn toohello gaan hoe toocreate een CI/CD-pipeline met Visual Studio Team Services en een Windows-VM waarop IIS wordt uitgevoerd.
