...
Hallo SPECInt benchmark scores weergeven na compute prestaties voor Azure krachtige VM selectie met Windows Server. COMPUTE benchmark scores zijn ook beschikbaar voor [virtuele Linux-machines](../linux/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).

## <a name="a-series---compute-intensive"></a>A-serie-rekenintensieve
| Grootte | vcpu 's | NUMA-knooppunten | CPU | Wordt uitgevoerd | Base snelheid Gem. | StdDev |
| --- | --- | --- | --- | --- | --- | --- |
...
Windows-getallen worden berekend door het uitvoeren van [SPECint 2006](https://www.spec.org/cpu2006/results/rint2006.html) op Windows Server. SPECint is uitgevoerd met behulp van Hallo base optie (resultaten van SPECint_rate2006), met één exemplaar per core. SPECint bestaat uit 12 afzonderlijke tests elke drie keer uitgevoerd, wordt de mediaanwaarde Hallo elke test duurt en weging van tooform een samengestelde score. Deze tests zijn vervolgens uitgevoerd tussen meerdere virtuele machines tooprovide Hallo gemiddelde scores weergegeven.
