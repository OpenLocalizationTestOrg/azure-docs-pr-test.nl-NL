...
In September 2016 Microsoft uitgebracht een functie waar u meerdere virtuele IP-adressen beheren met behulp van kunt een [Azure interne load balancer][load-balancer-multivip-overview]. Er bestaat al deze functionaliteit in hello Azure externe load balancer.
...
> [!NOTE]
> Deze functie is alleen beschikbaar in hello Azure Resource Manager-implementatiemodel.
...
4. [Hallo-database-exemplaar installeren][sap-ha-guide-9.2].  
 In deze stap maakt installeert u DBMS op een speciale WSFC-cluster.

5. [Installeren van de tweede clusterknooppunt Hallo][sap-ha-guide-9.3].  
