...
---
# <a name="provision-the-linux-data-science-virtual-machine"></a>De virtuele Linux-gegevenswetenschapmachine inrichten
...
Een [Ubuntu](machine-learning-data-science-dsvm-ubuntu-intro.md) installatiekopie is ook beschikbaar met veel van dezelfde hulpmiddelen als de installatiekopie van CentOS plus deep frameworks leren. Een [Windows](machine-learning-data-science-provision-vm.md) installatiekopie is ook beschikbaar.
...
* **Een Azure storage-account**: als u wilt maken, Zie [maken van een Azure storage-account](../storage/common/storage-create-storage-account.md#create-a-storage-account). U kunt ook kan de storage-account worden gemaakt als onderdeel van het proces van het maken van de virtuele machine als u niet wilt dat een bestaand account gebruiken.
...
2. Klik op **maken** (aan de onderkant) online zetten van de wizard.![ Configureer-gegevens-wetenschappelijke-vm](./media/machine-learning-data-science-linux-dsvm-intro/configure-linux-data-science-virtual-machine.png)
...
* De [gegevenswetenschap op de Linux wetenschappelijke virtuele Machine gegevens](machine-learning-data-science-linux-dsvm-walkthrough.md) overzicht toont u hoe u enkele algemene taken in het wetenschappelijke gegevens uitvoert met het Linux gegevens wetenschappelijke VM hier ingericht. 
