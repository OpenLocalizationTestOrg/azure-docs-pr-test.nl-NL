...
> [!NOTE]
> Zie voor een onderwerp waarin wordt uitgelegd hoe u Scala in plaats van Python gebruikt om taken voor een end-to-end gegevens wetenschap proces te voltooien, de [Gegevenswetenschap met Spark op Azure met behulp van Scala](machine-learning-data-science-process-scala-walkthrough.md).
> 
> 
...
**Gegevensverkenning en modellering met Spark:** verkennen van de gegevensset en maken, beoordelen en evalueren van de machine learning-modellen doorloopt de [binaire classificatie en regressie modellen voor gegevens met de MLlib Spark maken Toolkit](machine-learning-data-science-spark-data-exploration-modeling.md) onderwerp.

**Model verbruik:** Zie voor meer informatie over de classificatie en regressie modellen gemaakt in dit onderwerp te beoordelen, [Score en evalueren van Spark is gebouwd machine learning-modellen](machine-learning-data-science-spark-model-consumption.md).
