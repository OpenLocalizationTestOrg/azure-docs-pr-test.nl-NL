...
3. Klik op **Add**.
4. Typ een naam en beschrijving voor het nieuwe eindpunt. Selecteer het niveau van logboekregistratie en of de voorbeeldgegevens is ingeschakeld. Zie voor meer informatie over logboekregistratie [logboekregistratie inschakelen voor Machine Learning-webservices](machine-learning-web-services-logging.md).
...
5. Klik onder aan de pagina op **eindpunt toevoegen**. Zie voor meer informatie over het toevoegen van eindpunten [eindpunten maken](machine-learning-create-endpoint.md). 
...
[Het oplossen van de retraining van een klassieke Azure Machine Learning-webservice](machine-learning-troubleshooting-retraining-models.md)
