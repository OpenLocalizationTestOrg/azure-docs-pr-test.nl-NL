...
Bekijk de gedetailleerde gebruiksvoorbeeld voor een uitgebreid voorbeeld van het gebruik van de module in een Praktijkscenario [veel Machine Learning-modellen en web service-eindpunten maken van een experiment met behulp van PowerShell](machine-learning-create-models-and-endpoints-with-powershell.md).
