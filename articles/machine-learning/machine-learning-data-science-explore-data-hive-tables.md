...
* De gegevens is geüpload naar de Hive-tabellen in Azure HDInsight Hadoop-clusters. Als dit niet het geval is, volg de instructies in [maken en gegevens laden met Hive-tabellen](machine-learning-data-science-move-hive-tables.md) eerst gegevens uploaden naar Hive-tabellen.
* Externe toegang tot het cluster is ingeschakeld. Als u instructies nodig hebt, raadpleegt u [toegang tot de hoofd-knooppunt van Hadoop-Cluster](machine-learning-data-science-customize-hadoop-cluster.md#headnode).
* Als u instructies voor het indienen van Hive-query's nodig hebt, raadpleegt u [het Hive-query's verzenden](machine-learning-data-science-move-hive-tables.md#submit)
