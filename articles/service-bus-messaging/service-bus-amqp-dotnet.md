...
Waar `[namespace]` en `SharedAccessKey` worden opgehaald uit de [Azure-portal] [ Azure portal] wanneer u een Service Bus-naamruimte maken. Zie voor meer informatie [maken van een Service Bus-naamruimte met behulp van de Azure-portal][Create a Service Bus namespace using the Azure portal].
