...
Er kunnen problemen met de netwerkconnectiviteit tussen Azure VM's. Dit artikel bevat de stappen voor probleemoplossing waarmee u kunt dit probleem oplossen. 

[!INCLUDE [support-disclaimer](../../includes/support-disclaimer.md)]

## <a name="symptom"></a>Symptoom

Een virtuele machine van Azure kan geen verbinding met een andere virtuele machine in Azure.
...
8. [Kan geen verbinding met een VM-netwerkshare](#step-8-unable-to-connect-to-a-vm-network-share)
9. [Inter Vnet-connectiviteit](#step-9-inter-vnet-connectivity)

## <a name="troubleshooting-steps"></a>Stappen voor probleemoplossing

Volg deze stappen voor het oplossen van het probleem. Controleer of het probleem opgelost na elke stap is. 

### <a name="step-1-check-if-nic-is-misconfigured"></a>Stap 1: Controleer of NIC is onjuist geconfigureerd

Ga als volgt [netwerkinterface herstellen voor virtuele machine van Windows Azure](../virtual-machines/windows/reset-network-interface.md). 
...
2. Los de problemen op de onjuiste NIC of verwijderen van ongeldige NIC.  Vervolgens readd de NIC.
...
De firewall uitschakelen en vervolgens het resultaat te testen. Als het probleem is opgelost, Controleer de instellingen in de firewall en opnieuw in te schakelen.
...
U kunt een van de volgende methoden gebruiken om te controleren of VM-toepassing of Service op poort luistert
...
- Voer de **Telnet** opdracht op de virtuele machine naar zichzelf voor het testen van de poort. Als de test mislukt, is niet toepassing of service geconfigureerd om te luisteren op poort.
...
Een ACL biedt de mogelijkheid om selectief toestaan of weigeren van verkeer voor het eindpunt van een virtuele machine. Zie voor meer informatie [beheren de ACL voor een eindpunt](../virtual-machines/windows/classic/setup-endpoints.md#manage-the-acl-on-an-endpoint).
...
Gebruikmaken van [netwerk-Watcher IP-stroom controleren](../network-watcher/network-watcher-ip-flow-verify-overview.md) en [NSG stroom logboekregistratie](../network-watcher/network-watcher-nsg-flow-logging-overview.md) om te bepalen of er is een Netwerkbeveiligingsgroep of door de gebruiker gedefinieerde Route die netwerkverkeer verstoort. U kunt ook uw Inter Vnet-configuratie valideren [hier](https://support.microsoft.com/en-us/help/4032151/configuring-and-validating-vnet-or-vpn-connections).
