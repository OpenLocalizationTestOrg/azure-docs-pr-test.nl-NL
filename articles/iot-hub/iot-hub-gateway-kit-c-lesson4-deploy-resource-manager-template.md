...
- [Les 1: Uw NUC Intel instellen als een IoT-gateway](iot-hub-gateway-kit-c-lesson1-set-up-nuc.md)
- [Les 2: Bereid u voor uw hostcomputer en Azure IoT hub](iot-hub-gateway-kit-c-lesson2-get-the-tools-win32.md)
- [Les 3: Berichten ontvangen van SensorTag en berichten uit iothub](iot-hub-gateway-kit-c-lesson3-configure-ble-app.md)
...
[Alleen berichten permanent in Azure Storage](iot-hub-gateway-kit-c-lesson4-read-table-storage.md).
