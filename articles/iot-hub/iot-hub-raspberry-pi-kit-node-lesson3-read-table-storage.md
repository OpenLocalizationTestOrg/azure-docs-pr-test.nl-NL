...
Monitor Hallo apparaat-naar-cloud-berichten dat uit frambozen Pi 3 tooyour iothub worden verzonden als Hallo-berichten worden geschreven tooyour Azure Table storage. Als u problemen hebt, zoekt u naar oplossingen op Hallo [probleemoplossing pagina](iot-hub-raspberry-pi-kit-node-troubleshooting.md).
...
Voordat u deze procedure begint, moet is voltooid [hello Azure knipperen voorbeeldtoepassing uitvoeren op frambozen Pi 3](iot-hub-raspberry-pi-kit-node-lesson3-run-azure-blink.md).
...
[Hallo voorbeeld tooreceive cloud-naar-apparaat toepassingsberichten uitvoeren](iot-hub-raspberry-pi-kit-node-lesson4-send-cloud-to-device-messages.md)
