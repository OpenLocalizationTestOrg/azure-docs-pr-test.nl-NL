...
## <a name="add-functions-to-mainc-and-gulpfilejs"></a>Functies toevoegen aan main.c en gulpfile.js
1. De voorbeeldtoepassing openen in Visual Studio code met de volgende opdrachten:
   ...
   code .
   ```
2. Open de `main.c` bestand en voeg vervolgens de volgende functies na de blinkLED() functie:
...
3. De volgende condities voordat de `else if` blokkeren van de `receiveMessageCallback` functie:
