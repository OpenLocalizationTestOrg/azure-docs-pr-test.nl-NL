...
#### Gebruik Hallo IoT Gateway Starter Kit
##### [Intel NUC instellen als gateway](iot-hub-gateway-kit-c-lesson1-set-up-nuc.md)
##### [Verbinding maken met de Hallo gateway tooIoT Hub](iot-hub-gateway-kit-c-iot-gateway-connect-device-to-cloud.md)
##### [Hallo-gateway gebruiken voor de gegevensconversie](iot-hub-gateway-kit-c-use-iot-gateway-for-data-conversion.md)
...
### [IoT Hub berichten tooAzure gegevensopslag opslaan](iot-hub-store-data-in-azure-table-storage.md)
...
# Procedures
## Plannen
### [Vergelijking van IoT Hub tooEvent Hubs](iot-hub-compare-event-hubs.md)
...
##### [Apparaat-naar-cloudberichten tooIoT Hub te verzenden](iot-hub-devguide-messages-d2c.md)
##### [Apparaat-naar-cloud-berichten lezen uit Hallo ingebouwd eindpunt](iot-hub-devguide-messages-read-builtin.md)
...
#### [Beheer toegang tooIoT Hub](iot-hub-devguide-security.md)
...
### [Hallo IoT-apparaat SDK gebruiken voor C](iot-hub-device-sdk-c-intro.md)
#### [Hallo IoTHubClient gebruiken](iot-hub-device-sdk-c-iothubclient.md)
#### [Hallo serialisatiefunctie gebruiken](iot-hub-device-sdk-c-serializer.md)
...
### Firmware apparaat taken tooupdate-apparaat gebruiken
...
## Beheren
### Een IoT Hub maken 
#### [Hallo-portal gebruiken](iot-hub-create-through-portal.md)
...
#### [Hallo REST-API gebruiken](iot-hub-rm-rest.md)
...
#### [Hallo-portal gebruiken](iot-hub-configure-file-upload.md)
...
## Beveiligen
### [Beveiliging van Hallo gemalen](iot-hub-security-ground-up.md)
### [Aanbevolen procedures voor beveiliging](iot-hub-security-best-practices.md)
