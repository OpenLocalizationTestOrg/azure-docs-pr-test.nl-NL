...
> [!NOTE]
> U hoeft niet in deze stap uitvoeren als u het HDInsight-cluster met Data Lake Store als standaard opslag hebt gemaakt. De cluster-vervaardigingsproces voegt voorbeeldgegevens in de Data Lake Store-account dat u opgeeft tijdens het maken van het cluster. Ga naar de sectie [gebruik HDInsight Spark-cluster met Data Lake Store](#use-an-hdinsight-spark-cluster-with-data-lake-store).
>
>
...
2. Voer de volgende opdracht om een specifieke blob kopiëren van de Broncontainer naar een Data Lake Store:
   ...
   >
   >
3. U wordt gevraagd de referenties voor de Azure-abonnement waaronder die u een Data Lake Store-account hebt invoeren. Hier ziet u uitvoer ziet er als volgt:
...
* [Een zelfstandige Scala toepassing uit te voeren op Apache Spark-cluster maken](hdinsight-apache-spark-create-standalone-application.md)
* [Gebruik van HDInsight-hulpprogramma's in Azure Toolkit voor IntelliJ Spark-toepassingen voor HDInsight Spark Linux-cluster maken](hdinsight-apache-spark-intellij-tool-plugin.md)
* [Gebruik van HDInsight-hulpprogramma's in Azure Toolkit voor Eclipse Spark-toepassingen voor HDInsight Spark Linux-cluster maken](hdinsight-apache-spark-eclipse-tool-plugin.md)
