...
Zie voor gedetailleerde informatie over de compatibiliteit tussen Mono en .NET de [Mono compatibiliteit (http://www.mono-project.com/docs/about-mono/compatibility/)](http://www.mono-project.com/docs/about-mono/compatibility/) document.
...
> [!IMPORTANT]
> De analyzer kan geen catch elk probleem met uw oplossing. Bijvoorbeeld, een bestandspad van `c:\temp\file.txt` wordt beschouwd als OK omdat Mono wordt uitgevoerd op Windows en het pad ongeldig in deze context is. Het pad is echter niet geldig voor een Linux-platform.
