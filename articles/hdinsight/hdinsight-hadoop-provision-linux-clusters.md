...
Informatie over het instellen en configureren van clusters in HDInsight met Hadoop, Spark, Kafka, interactieve Hive, HBase, R Server of Storm. Ook informatie over het aanpassen van clusters en beveiliging toevoegen door ze te verbinden met een domein.
