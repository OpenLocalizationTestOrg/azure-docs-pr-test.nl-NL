...
#### [Hallo Hive-weergave gebruiken](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [Hallo HDInsight tools voor Visual Studio gebruiken](hdinsight-hadoop-use-hive-visual-studio.md)
#### [Extern bureaublad gebruiken](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [Hallo Query-Console gebruiken](hdinsight-hadoop-use-hive-query-console.md)
...
### [Voorbeelden van Hallo MapReduce uitvoeren](hdinsight-hadoop-run-samples-linux.md)
...
#### [Hallo .NET SDK gebruiken](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [Schrijven tooData Lake Store](hdinsight-storm-write-data-lake-store.md)
...
### [HDInsight Tools toocreate Spark apps gebruiken](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [HDInsight Tools toodebug Spark apps op afstand via SSH gebruiken](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [Verbinding maken met Excel tooHadoop](hdinsight-connect-excel-hive-odbc-driver.md)
### [Verbinding maken met behulp van Hallo Hive JDBC-stuurprogramma](hdinsight-connect-hive-jdbc-driver.md)
...
### [Verbinding maken met HDInsight tooyour on-premises netwerk](connect-on-premises-network.md)
...
#### [REST tooinstall apps gebruiken](https://msdn.microsoft.com/library/mt706515.aspx)
#### [Publiceren van HDInsight apps tooAzure Marketplace](hdinsight-apps-publish-applications.md)
## Beveiligen
...
### [Beperken van toegang toodata](hdinsight-storage-sharedaccesssignature-permissions.md)
## Beheren
...
#### [Gebruik cURL en hello Azure REST-API](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [Hallo .NET SDK gebruiken](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [Hello Azure CLI gebruiken](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [Gebruik hello Azure-portal](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [Hello Azure CLI gebruiken](hdinsight-administer-use-command-line.md)
### [Clusters met Hallo Ambari-webgebruikersinterface beheren](hdinsight-hadoop-manage-ambari.md)
...
### [TooResource Manager ontwikkelingsprogramma's migreren](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [Beschikbaarheid en betrouwbaarheid](hdinsight-high-availability-linux.md)
### [HDInsight-cluster toonewer versie upgraden](hdinsight-upgrade-cluster.md)
...
#### [Ambari-weergaven toodebug Tez-taken gebruiken](hdinsight-debug-ambari-tez-view.md)
...
# Verwant
## Windows-clusters
### [Windows-clusters tooLinux clusters migreren](hdinsight-migrate-from-windows-to-linux.md)
### [.NET-oplossingen tooLinux clusters migreren](hdinsight-hadoop-migrate-dotnet-to-linux.md)
...
### [Giraph tooprocess grootschalige grafieken gebruiken](hdinsight-hadoop-giraph-install.md)
...
### [Maven toobuild Java-toepassingen gebruiken](hdinsight-hbase-build-java-maven.md)
### [Hallo Tez UI toodebug Tez-taken gebruiken](hdinsight-debug-tez-ui.md)
...
### [Monitor voor clusters met Hallo Ambari-API](hdinsight-monitor-use-ambari-api.md)

# Resources
## [Azure-roadmap](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [Vraag hulp bij het Hallo-forum](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
