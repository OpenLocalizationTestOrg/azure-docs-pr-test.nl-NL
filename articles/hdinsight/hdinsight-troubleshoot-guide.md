...
|![Storm](./media/hdinsight-troubleshoot-guide/STORM.png)<br>[Storm oplossen](hdinsight-troubleshoot-STORM.md)|<br>[Hoe krijg ik toegang tot Hallo Storm-gebruikersinterface op een cluster](hdinsight-troubleshoot-storm.md#how-do-i-access-the-storm-ui-on-a-cluster)<br><br>[Hoe moet ik Storm event hub spout controlepunt informatie overbrengen van een topologie tooanother](hdinsight-troubleshoot-storm.md#how-do-i-transfer-storm-event-hub-spout-checkpoint-information-from-one-topology-to-another)<br><br>[Hoe ik Storm binaire bestanden vinden op een cluster](hdinsight-troubleshoot-storm.md#how-do-i-locate-storm-binaries-on-a-cluster)<br><br>[Hoe bepaal ik implementatietopologie Hallo van een Storm-cluster](hdinsight-troubleshoot-storm.md#how-do-i-determine-the-deployment-topology-of-a-storm-cluster)<br><br>[Hoe ik Storm event hub spout binaire bestanden voor de ontwikkeling van vinden](hdinsight-troubleshoot-storm.md#how-do-i-locate-storm-event-hub-spout-binaries-for-development)<br><br>[Hoe ik Storm Log4J configuratiebestanden op clusters vinden](hdinsight-troubleshoot-storm.md#how-do-i-locate-storm-log4j-configuration-files-on-clusters)|
...
| Fouten | - [Begrijpen en WebHCat fouten oplossen](hdinsight-hadoop-templeton-webhcat-debug-errors.md)<br>- [Hive-instellingen toofix OutofMemory-fout](hdinsight-hadoop-hive-out-of-memory-error-oom.md) |
| Hulpprogramma's | - [Ambari-weergaven toodebug Tez-taken gebruiken](hdinsight-debug-ambari-tez-view.md)<br>- [Hive-query's optimaliseren](hdinsight-hadoop-optimize-hive-query.md) |
