...
4. PowerShell wordt u gevraagd om uw tenant-ID. Gebruik de GUID van de Directory-ID die u hebt gekopieerd uit de Azure-portal in de sectie vereisten.
5. Aanmelden bij Azure AD als een beheerder.
