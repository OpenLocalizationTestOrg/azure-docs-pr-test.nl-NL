...
* Zie voor meer informatie over Cosmos DB, de [startpagina van Azure DB die Cosmos documentatie](https://azure.microsoft.com/documentation/services/documentdb/).
