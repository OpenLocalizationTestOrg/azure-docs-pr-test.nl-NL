...
* [Bouwen en implementeren van een Node.js-web-app in Azure met WebMatrix](../app-service-web/web-sites-nodejs-use-webmatrix.md)
...
Voor een voorbeeld van de omgevingsvariabelen instellen in de [Azure-portal](https://portal.azure.com) Zie voor een Azure-Website [Node.js-web-app met behulp van de Service Azure-tabel](../app-service-web/storage-nodejs-use-table-storage-web-site.md).
