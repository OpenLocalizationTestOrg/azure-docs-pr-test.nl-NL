...
---
# <a name="azure-cosmos-db-create-a-firewall-using-hello-azure-cli"></a>Azure Cosmos DB: Maak een firewall met hello Azure CLI
...
| [AZ cosmosdb maken](https://docs.microsoft.com/cli/azure/cosmosdb#create) | Maakt een CosmosDB Azure-account. |
| [AZ cosmosdb update](https://docs.microsoft.com/cli/azure/cosmosdb#update) | Een Azure-CosmosDB account tooinclude firewall-instellingen voor updates. |
