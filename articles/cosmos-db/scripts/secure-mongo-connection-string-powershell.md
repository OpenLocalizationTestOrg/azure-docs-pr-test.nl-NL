...
---
# <a name="get-an-azure-cosmos-db-connection-string-for-mongodb-apps-using-powershell"></a>Een Azure DB die Cosmos-verbindingsreeks ophalen voor MongoDB-apps met behulp van PowerShell

Dit voorbeeld wordt een Azure DB die Cosmos-verbindingsreeks voor MongoDB-apps met behulp van PowerShell. 
