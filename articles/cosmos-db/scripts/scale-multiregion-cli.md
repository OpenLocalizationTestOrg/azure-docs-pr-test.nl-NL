...
---
# <a name="replicate-an-azure-cosmos-db-database-account-in-multiple-regions-and-configure-failover-priorities-using-hello-azure-cli"></a>Een databaseaccount Azure Cosmos DB in meerdere regio's worden gerepliceerd en het configureren van failover prioriteiten hello Azure CLI gebruiken

Dit voorbeeld elk soort account voor Azure DB die Cosmos-database in meerdere regio's worden gerepliceerd en failover prioriteiten hello Azure CLI met configureert.
