...
Een Azure Batch account maken met de [Azure-portal](http://manage.windowsazure.com/). Zie [maken en beheren van Azure Batch-account](../batch/batch-account-create-portal.md). Noteer de sleutel Azure Batch-account en -account. U kunt ook [New-AzureRmBatchAccount](https://msdn.microsoft.com/library/mt603749.aspx) cmdlet om een Azure Batch-account te maken. Zie [aan de slag met Azure Batch PowerShell-cmdlets](../batch/batch-powershell-cmdlets-get-started.md) voor gedetailleerde instructies over het gebruik van deze cmdlet.
