...
| Beleid |Definieert de criteria of de conditie van de segmenten van de gegevensset moeten voldoen. <br/><br/>Zie voor meer informatie de [gegevensset beleid](#Policy) sectie. |Nee |N.v.t. |
...
| Eigenschap | Beschrijving | Vereist | Standaard |
| --- | --- | --- | --- |
| Frequentie |Hiermee geeft u tijdseenheid voor de gegevensset segment productie.<br/><br/><b>Ondersteunde frequentie</b>: minuut, uur, dag, Week, maand |Ja |N.v.t. |
