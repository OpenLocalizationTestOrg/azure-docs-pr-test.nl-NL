...
U kunt vastmaken een diagram of de tabel op een van uw [dashboards gedeeld](app-insights-dashboards.md) -Klik op de pincode. (Mogelijk moet u [upgrade pakket de prijzen van uw app](app-insights-pricing.md) voor deze functie inschakelen.) 
