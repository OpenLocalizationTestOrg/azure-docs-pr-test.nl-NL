...
### [Gebruik Twilio toomake een telefonische oproep (.NET)](../partner-twilio-cloud-services-dotnet-phone-call-web-role.md)
...
#### [Een taak tooInstall .NET gebruiken op een Cloudservice-functie](cloud-services-dotnet-install-dotnet.md)
...
### [Verbinding maken met aangepaste tooa domeincontroller](cloud-services-connect-to-custom-domain.md)
...
### [Gebruik van Python toomanage Azure-Resources](cloud-services-python-how-to-use-service-management.md)
...
### [Diagnostische gegevens tooApp Insights verzenden](cloud-services-dotnet-diagnostics-applicationinsights.md)
...
### [Rol toostart is mislukt](cloud-services-troubleshoot-roles-that-fail-start.md)
