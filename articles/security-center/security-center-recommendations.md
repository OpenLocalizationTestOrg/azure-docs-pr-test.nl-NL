...
Nadat er een beveiligingsbeleid is ingesteld, wordt met Security Center de beveiligingsstatus van de Azure-resources geanalyseerd om potentiële beveiligingsproblemen op te sporen. De **aanbevelingen** tegel op de **Security Center** blade laat u weten van het totale aantal geïdentificeerd door Security Center aanbevelingen.

![Aanbevelingen tegel][1]

Kunt u de details van elke aanbeveling:

Selecteer de **aanbevelingen tegel** op de **Security Center** blade. De **aanbevelingen** blade wordt geopend.
