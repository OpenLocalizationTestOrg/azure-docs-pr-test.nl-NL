...
## [Gebruik PowerShell toomanage Traffic Manager](traffic-manager-powershell-arm.md)
## [Wijs de Internet domain tooTraffic Manager](traffic-manager-point-internet-domain.md)
## Problemen oplossen
