...
U kunt ook [automatische databaseback-ups](sql-database-automated-backups.md) maken een [kopiëren van de database](sql-database-copy.md) op een logische server in elke regio. 
...
* Zie voor meer informatie over lange bewaartermijn van de back-up, [lange bewaartermijn van de back-up](sql-database-long-term-retention.md)
