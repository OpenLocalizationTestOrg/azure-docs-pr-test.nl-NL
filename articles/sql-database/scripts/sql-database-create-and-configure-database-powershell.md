...
---
# <a name="use-powershell-toocreate-a-single-azure-sql-database-and-configure-a-firewall-rule"></a>Gebruik PowerShell toocreate één Azure SQL database en een firewallregel configureren

Voorbeeld van deze PowerShell-script maakt een Azure SQL database en configureert u een firewallregel op serverniveau. Zodra het Hallo-script is uitgevoerd, Hallo die SQL-Database toegankelijk is vanaf alle Azure-services en Hallo geconfigureerd IP-adres. 
