...
---
# <a name="use-powershell-tooconfigure-active-geo-replication-for-a-single-azure-sql-database"></a>Gebruik PowerShell tooconfigure actieve geo-replicatie voor een enkele Azure SQL database

Voorbeeld van deze PowerShell-script configureert actieve geo-replicatie voor een enkele Azure SQL database en failover tooa secundaire replica van hello Azure SQL-database.
