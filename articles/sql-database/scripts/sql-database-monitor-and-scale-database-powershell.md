...
[!code-powershell[belangrijkste](../../../powershell_scripts/sql-database/monitor-and-scale-database/monitor-and-scale-database.ps1?highlight=13-14 "bewaken en schalen één SQL-Database")]
