...
---
# <a name="use-powershell-tooimport-a-bacpac-file-into-an-azure-sql-database"></a>Gebruik PowerShell tooimport een Bacpac-bestand in een Azure SQL database
...
| [Nieuwe AzureRmSqlServer](/powershell/module/azurerm.sql/new-azurermsqlserver) | Maakt een logische server dat hosts Hallo SQL-Database. |
| [New-AzureRmSqlServerFirewallRule](/powershell/module/azurerm.sql/new-azurermsqlserverfirewallrule) | Maakt een firewall regel tooallow toegang tooall SQL-Databases op Hallo-server uit Hallo opgegeven IP-adresbereik. |
| [Nieuwe AzureRmSqlDatabaseImport](/powershell/module/azurerm.sql/new-azurermsqldatabaseimport) | De invoer een Bacpac-bestand en een nieuwe database maken op Hallo-server. |
