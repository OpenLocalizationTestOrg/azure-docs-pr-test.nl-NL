...
Bij het maken van een naamruimte Event Hubs, de service een 256-bits SAS-sleutel met de naam genereert **RootManageSharedAccessKey**. Deze sleutel verleent verzenden, luisteren en beheer van rechten aan de naamruimte. U kunt ook aanvullende sleutels maken. Het is raadzaam het produceren van een sleutel dat verleent machtigingen aan de specifieke event hub verzendt. Voor de rest van dit onderwerp wordt ervan uitgegaan dat u deze sleutel naam **EventHubSendKey**.
