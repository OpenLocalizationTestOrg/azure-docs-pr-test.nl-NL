...
4. Controleer de **App registraties** instelling. Indien ingesteld op **Ja**, niet-beheerders kunnen zich registreren AD-apps. Deze instelling betekent dat elke gebruiker in de Azure AD-tenant een app kunt registreren. U kunt verdergaan naar [controleren Azure-abonnement machtigingen](#check-azure-subscription-permissions).

     ![app-registraties weergeven](./media/resource-group-create-service-principal-portal/view-app-registrations.png)
5. Als de app-registraties instelling is ingesteld op **Nee**, alleen de beheerder gebruikers apps kunnen registreren. U moet controleren of uw account een beheerder voor de Azure AD-tenant is. Selecteer **overzicht** en **een gebruiker zoeken** van snelle taken.
...
6. Geef een naam en de URL voor de toepassing. Selecteer een **Web-app / API** of **systeemeigen** voor het type van de toepassing die u wilt maken. Na het instellen van de waarden, selecteer **maken**.
...
2. Kopieer de **map-ID**. Deze waarde is uw tenant-ID.
...
6. Selecteer de rol die u wilt toewijzen aan de toepassing. De volgende afbeelding toont de **lezer** rol.
...
9. Selecteer **OK** voltooid de rol toe te wijzen. Ziet u uw toepassing in de lijst met gebruikers die zijn toegewezen aan een rol voor deze scope.
