...
* [REST-API voor Automation](http://msdn.microsoft.com/library/mt662285.aspx)
...
* [Meld u Search REST-API](../log-analytics/log-analytics-log-search-api.md)
* [Waarschuwing REST-API](../log-analytics/log-analytics-api-alerts.md)
* [Log Analytics PowerShell-Cmdlets](https://msdn.microsoft.com/library/mt188224.aspx)
* [Log Analytics-bibliotheek voor .NET](https://www.nuget.org/packages/Microsoft.Azure.Management.OperationalInsights/0.16.0-preview)

## <a name="service-map"></a>Serviceoverzicht
* [Serviceoverzicht documentatie](operations-management-suite-service-map.md)
* [Serviceoverzicht REST-API](https://docs.microsoft.com/rest/api/servicemap/)
