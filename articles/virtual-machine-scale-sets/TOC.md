...
# Aan de slag
## [Implementeer een schaal in Hallo portal instellen](virtual-machine-scale-sets-portal-create.md)
...
## Implementeren
### [Maak met Hallo-portal](virtual-machine-scale-sets-portal-create.md)
...
### [Een scale set sjabloon toouse beheerde schijf converteren](virtual-machine-scale-sets-convert-template-to-md.md)
...
### [Een sjabloon toomanaged schijven converteren](virtual-machine-scale-sets-convert-template-to-md.md)
