...
---
# <a name="customize-web-application-firewall-rules-through-hello-azure-cli-20"></a>Web application firewall-regels via hello Azure CLI 2.0 aanpassen
...
Hallo volgende codevoorbeelden laten zien hoe tooview regels en de regels van de groepen die kunnen worden geconfigureerd.

### <a name="view-rule-groups"></a>Groepen van de regel weergeven

Hallo volgende voorbeeld ziet u hoe tooview regelgroepen Hallo:
...
Hallo volgende voorbeeld ziet u hoe tooview regels in een opgegeven regel-groep:
