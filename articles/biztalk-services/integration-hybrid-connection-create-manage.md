...
**Hybride verbindingen met behulp van Web-Apps maken**, Zie [verbinding maken met Azure Web Apps en een On-Premises Resource](../app-service-web/web-sites-hybrid-connection-get-started.md). U kunt ook de hybride verbinding Manager (HCM) installeren uit uw web-app de voorkeursmethode is. 
...
Selecteer voor een Web-App of mobiele apps in Azure App Service een koppeling naar een bestaande hybride verbinding, **gebruik een bestaande hybride verbinding** in de blade hybride verbindingen. Zie [toegang tot on-premises resources met behulp van hybride verbindingen in Azure App Service](../app-service-web/web-sites-hybrid-connection-get-started.md).
...
[Verbinding maken met Azure-Web-Apps een On-Premises Resource](../app-service-web/web-sites-hybrid-connection-get-started.md)  
[Verbinding maken met on-premises SQL Server vanuit Azure-Web-Apps](../app-service-web/web-sites-hybrid-connection-connect-on-premises-sql-server.md)   
