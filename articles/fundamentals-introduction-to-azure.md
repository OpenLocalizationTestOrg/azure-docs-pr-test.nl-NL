...
De pagina [vergelijking van Azure Web Apps, Cloudservices en virtuele Machines](app-service-web/choose-web-site-cloud-service-vm.md) voorziet in gedetailleerde informatie over het kiezen van een Compute-model.
