...
3. In het zoekvak Hallo Hallo Microsoft Update-catalogus, invoeren Hallo-Knowledge Base (KB) van de hotfix Hallo gewenste toodownload, bijvoorbeeld **3179904**, en klik vervolgens op **Search**.
   
    Hallo hotfix wordt weergegeven, bijvoorbeeld **cumulatieve Software bundel Update 2.2 voor StorSimple 8000-serie**.
...
5. Zoeken naar aanvullende hotfixes die worden vermeld in de bovenstaande Hallo-tabel (**3103616**, **3146621**), en elke mandje toohello toe te voegen.
...
4. Type **Y** wanneer na vragen aan gebruiker tooconfirm Hallo hotfix-installatie.
   ...
   > [!IMPORTANT]
   > Als u Update 2.2 installeert, alleen Hallo binair bestand voorafgegaan door 'all-hcsmdssoftwareudpate' te installeren. Update niet installeert Hallo Cis en Hallo MDS agent vooraf worden gegaan door alle cismdsagentupdatebundle. Fout toodo dus leidt tot een fout opgetreden. 
...
1. Nadat het Hallo software-update is voltooid, controleert u of softwareversies Hallo-systeem. Type:
   ...
   * `MdsAgentVersion: 30.0.4698.16` 
     ...
     > [!IMPORTANT]
     > U moet opnieuw opstarten Hallo actieve controller via Hallo `Restart-HcsController` cmdlet alvorens Hallo resterende updates toe te passen. 
     > 
     > 
2. Herhaal stap 3-5 tooinstall Hallo resterende hotfixes reguliere-modus.
   
   * update van de iSCSI-Hallo KB3146621
   * Hallo WMI update KB3103616
3. Deze stap overslaan als u Update 2 bijwerkt. Als u een eerdere tooUpdate van versie 2 bijwerkt, moet u ook toodownload:
