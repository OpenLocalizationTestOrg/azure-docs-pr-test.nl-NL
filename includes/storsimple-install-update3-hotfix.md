...
3. In het zoekvak Hallo Hallo Microsoft Update-catalogus, invoeren Hallo-Knowledge Base (KB) van de hotfix Hallo gewenste toodownload, bijvoorbeeld **3186843**, en klik vervolgens op **Search**.
   
    Hallo hotfix wordt weergegeven, bijvoorbeeld **cumulatieve Software bundel Update 3.0 voor StorSimple 8000-serie**.
...
5. Zoeken naar aanvullende hotfixes die worden vermeld in de bovenstaande Hallo-tabel (**3186859**), en elke mandje toohello toe te voegen.
...
1. Nadat het Hallo software-update is voltooid, controleert u of softwareversies Hallo-systeem. Type:
   ...
   * `MdsAgentVersion: 30.0.4698.16`
     ...
     > 
     > 
2. Herhaal stap 3-5 tooinstall Hallo LSI stuurprogramma en firmware hotfix **KB3186859**. Nadat het Hallo-hotfix is geïnstalleerd, gebruikt u Hallo `Get-HcsSystem` cmdlet. Hallo LSI versie moet:
   
   * `Lsisas2Version: 2.0.78.00`
3. Herhaal stap 3-5 tooinstall Hallo Storport en Spaceport update **KB3121261**.
4. Als u van Update 2 of oudere versie bijwerken wilt, moet u ook toodownload:
