* [Een app-voetafdruk met verschillende geografische gebieden instellen](../articles/app-service-web/app-service-app-service-environment-geo-distributed-scale.md)
* [Een gelaagde beveiligingsarchitectuur implementeren](../articles/app-service-web/app-service-app-service-environment-layered-security.md) 
* [Firewall voor de webtoepassing met een App Service-omgeving configureren](../articles/app-service-web/app-service-app-service-environment-web-application-firewall.md)
