...
| Netwerk |Virtueel netwerk met zowel de ExpressRoute-Gateway en de VPN-Gateway  | Verwijder de VPN-Gateway vóór de migratie en de VPN-Gateway opnieuw zodra de migratie is voltooid. Meer informatie over [ExpressRoute migratie](../articles/expressroute/expressroute-migration-classic-resource-manager.md).|
| Netwerk |ExpressRoute met autorisatie koppelingen  | Verwijder de ExpressRoute-circuit met de netwerkverbinding virtaul vóór de migratie en maak de verbinding opnieuw zodra de migratie is voltooid. Meer informatie over [ExpressRoute migratie](../articles/expressroute/expressroute-migration-classic-resource-manager.md). |
...
| Compute |Azure Security Center-uitbreidingen met een VNET met een VPN-gateway in de doorvoer-verbinding of ExpressRoute-gateway met on-premises DNS-server |Azure Security Center installeert automatisch extensies op uw virtuele Machines om te controleren van de beveiliging en waarschuwingen worden gegeven. Deze uitbreidingen ophalen meestal automatisch geïnstalleerd als het Azure Security Center-beleid is ingeschakeld op het abonnement. Migratie van de ExpressRoute-gateway wordt momenteel niet ondersteund en VPN-gateways met onderweg connectiviteit verliest lokale toegang. Verwijderen van ExpressRoute gateway of migreren VPN-gateway met onderweg connectiviteit zorgt ervoor dat toegang tot internet voor VM-storage-account moet worden verbroken als u doorgaat met het doorvoeren van de migratie. De migratie niet worden voortgezet als dit gebeurt als u de guest agent statusblob kan niet worden ingevuld. Het is raadzaam drie uur voordat u doorgaat met de migratie van Azure Security Center-beleid voor het abonnement uitschakelen. |
