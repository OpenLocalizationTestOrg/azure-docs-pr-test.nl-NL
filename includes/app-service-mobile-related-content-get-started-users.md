...
* [Verificatie tooa Web-App toevoegen](../articles/app-service-web/app-service-web-get-started-2.md#authenticate-your-users)
* Verificatie tooyour mobiele App toevoegen: [iOS][ios-get-started-users], [Android][android-get-started-users], [universele Windows-] [ windows-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users], [Xamarin.Forms] [ xamarin-forms-get-started-users], [Cordova][cordova-get-started-users]  
  Meer informatie over hoe tooadd App Service verificatie tooyour mobiele app.
* Verificatie in API-Apps: [UPN](../articles/app-service-api/app-service-api-dotnet-user-principal-auth.md), [service-principal](../articles/app-service-api/app-service-api-dotnet-service-principal-auth.md)  
  Meer informatie over hoe toosecure uw API-app met App Service-verificatie.
